...
namespace BoundTreeGenerator
{
    internal sealed class BoundNodeClassWriter_CS : BoundNodeClassWriter
    {
        ...
        protected override void ImportNamespace(string nsName) => WriteLine($"using {nsName};");
        ...
        //    LBrace();
        //}
   //     protected override string GetModifiers(TreeType node) => (node is AbstractNode) ? "abstract " : CanBeSealed(node) ? "sealed " : "";

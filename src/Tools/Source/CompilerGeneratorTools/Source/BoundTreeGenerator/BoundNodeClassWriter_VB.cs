...
namespace BoundTreeGenerator
{
    internal sealed class BoundNodeClassWriter_VB : BoundNodeClassWriter
    {
        ...
        #region "block creation helpers"
          void ReturnType(string type) => WriteLine(AsType(type), thenIndent: false);
        ...
        private void Write_End(string text, bool undent = false, bool afterBlankLine = false, bool thenBlankLine = false) =>
        ...
        protected override void End_Class(bool thenBlankLine = false) => Write_End(Class(), thenBlankLine: thenBlankLine);
        private void End_Function() => Write_End(Function(), thenBlankLine: true);
        ...
        private string NameAsType(string name, string typename, bool isNew = false)=> $"{ToCamelCase(name)}{AsType(typename,isNew)}";

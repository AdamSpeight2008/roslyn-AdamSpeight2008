...
namespace Microsoft.CodeAnalysis.CSharp
  ...
  internal abstract partial class BoundEqualsValue
  {
    ...
    kind, syntax, hasErrors{
      ...
      Debug.Assert(value != null, "Field 'value' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")this.Locals = localsthis.Value = value
    }
    public  ImmutableArray<LocalSymbol> Locals { get; }public  BoundExpression Value { get; }
  }
  internal sealed partial class BoundFieldEqualsValue
  {
    ...
    BoundKind.FieldEqualsValue, syntax, locals, value, hasErrors || value.HasErrors(){
      ...
      Debug.Assert(!locals.IsDefault, "Field 'locals' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")
      Debug.Assert(value != null, "Field 'value' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")this.Field = field
    }
  ...
  internal sealed partial class BoundPropertyEqualsValue
  {
    ...
    BoundKind.PropertyEqualsValue, syntax, locals, value, hasErrors || value.HasErrors(){
      ...
      Debug.Assert(!locals.IsDefault, "Field 'locals' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")
      Debug.Assert(value != null, "Field 'value' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")this.Property = property
    }
  ...
  internal sealed partial class BoundParameterEqualsValue
  {
    ...
    BoundKind.ParameterEqualsValue, syntax, locals, value, hasErrors || value.HasErrors(){
      ...
      Debug.Assert(!locals.IsDefault, "Field 'locals' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")
      Debug.Assert(value != null, "Field 'value' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")this.Parameter = parameter
    }
  ...
  internal sealed partial class BoundGlobalStatementInitializer
  {
    ...
    BoundKind.GlobalStatementInitializer, syntax, hasErrors || statement.HasErrors(){
      Debug.Assert(statement != null, "Field 'statement' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")this.Statement = statement
    }
  ...
  internal abstract partial class BoundValuePlaceholderBase
  {
  ...
  internal sealed partial class BoundDeconstructValuePlaceholder
  {
    ...
    BoundKind.DeconstructValuePlaceholder, syntax, type, hasErrors{
      Debug.Assert(type != null, "Field 'type' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")this.ValEscape = valEscape
    }
  ...
  internal sealed partial class BoundPassByCopy
  {
    ...
    BoundKind.PassByCopy, syntax, type, hasErrors || expression.HasErrors(){
      Debug.Assert(expression != null, "Field 'expression' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")this.Expression = expression
    }
  ...
  internal sealed partial class BoundBadExpression
  {
    ...
    BoundKind.BadExpression, syntax, type, hasErrors || childBoundNodes.HasErrors(){
      ...
      Debug.Assert(!childBoundNodes.IsDefault, "Field 'childBoundNodes' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")this.ResultKind = resultKindthis.Symbols = symbolsthis.ChildBoundNodes = childBoundNodes
    }
  ...
  internal sealed partial class BoundBadStatement
  {
    ...
    BoundKind.BadStatement, syntax, hasErrors || childBoundNodes.HasErrors(){
      Debug.Assert(!childBoundNodes.IsDefault, "Field 'childBoundNodes' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")this.ChildBoundNodes = childBoundNodes
    }
  ...
  internal sealed partial class BoundTypeExpression
  {
    ...
    BoundKind.TypeExpression, syntax, type, hasErrors || boundContainingTypeOpt.HasErrors(){
      Debug.Assert(type != null, "Field 'type' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")this.AliasOpt = aliasOptthis.InferredType = inferredTypethis.BoundContainingTypeOpt = boundContainingTypeOpt
    }
  ...
  internal sealed partial class BoundTypeOrValueExpression
  {
    ...
    BoundKind.TypeOrValueExpression, syntax, type, hasErrors{
      Debug.Assert(type != null, "Field 'type' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")this.Data = data
    }
  ...
  internal sealed partial class BoundNamespaceExpression
  {
    ...
    BoundKind.NamespaceExpression, syntax, null, hasErrors{
      Debug.Assert(namespaceSymbol != null, "Field 'namespaceSymbol' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")this.NamespaceSymbol = namespaceSymbolthis.AliasOpt = aliasOpt
    }
    ...
    BoundKind.NamespaceExpression, syntax, null{
      Debug.Assert(namespaceSymbol != null, "Field 'namespaceSymbol' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")this.NamespaceSymbol = namespaceSymbol;
  ...
  internal sealed partial class BoundUnaryOperator
  {
    ...
    BoundKind.UnaryOperator, syntax, type, hasErrors || operand.HasErrors(){
      ...
      Debug.Assert(type != null, "Field 'type' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")this.OperatorKind = operatorKindthis.Operand = operandthis.ConstantValueOpt = constantValueOptthis.MethodOpt = methodOptthis.ResultKind = resultKind
    }
  ...
  internal sealed partial class BoundIncrementOperator
  {
    ...
    BoundKind.IncrementOperator, syntax, type, hasErrors || operand.HasErrors(){
      Debug.Assert(operand != null, "Field 'operand' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")
      Debug.Assert(type != null, "Field 'type' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")this.OperatorKind = operatorKindthis.Operand = operandthis.MethodOpt = methodOptthis.OperandConversion = operandConversionthis.ResultConversion = resultConversionthis.ResultKind = resultKind
    }
  ...
  internal sealed partial class BoundAddressOfOperator
  {
    ...
    BoundKind.AddressOfOperator, syntax, type, hasErrors || operand.HasErrors(){
      Debug.Assert(operand != null, "Field 'operand' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")
      Debug.Assert(type != null, "Field 'type' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")this.Operand = operandthis.IsManaged = isManaged
    }
  ...
  internal sealed partial class BoundPointerIndirectionOperator
  {
    ...
    BoundKind.PointerIndirectionOperator, syntax, type, hasErrors || operand.HasErrors(){
      Debug.Assert(operand != null, "Field 'operand' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")
      Debug.Assert(type != null, "Field 'type' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")this.Operand = operand
    }
  ...
  internal sealed partial class BoundPointerElementAccess
  {
    ...
    BoundKind.PointerElementAccess, syntax, type, hasErrors || expression.HasErrors() || index.HasErrors(){
      ...
      Debug.Assert(type != null, "Field 'type' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")this.Expression = expressionthis.Index = indexthis.Checked = @checked
    }
  ...
  internal sealed partial class BoundRefTypeOperator
  {
    ...
    BoundKind.RefTypeOperator, syntax, type, hasErrors || operand.HasErrors(){
      Debug.Assert(operand != null, "Field 'operand' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")
      Debug.Assert(type != null, "Field 'type' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")this.Operand = operandthis.GetTypeFromHandle = getTypeFromHandle
    }
  ...
  internal sealed partial class BoundBinaryOperator
  {
    ...
    BoundKind.BinaryOperator, syntax, type, hasErrors || left.HasErrors() || right.HasErrors(){
      ...
      Debug.Assert(type != null, "Field 'type' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")this.OperatorKind = operatorKindthis.Left = leftthis.Right = rightthis.ConstantValueOpt = constantValueOptthis.MethodOpt = methodOptthis.ResultKind = resultKind
    }
  ...
  internal sealed partial class BoundTupleBinaryOperator
  {
    ...
    BoundKind.TupleBinaryOperator, syntax, type, hasErrors || left.HasErrors() || right.HasErrors() || convertedLeft.HasErrors() || convertedRight.HasErrors(){
      ...
      Debug.Assert(type != null, "Field 'type' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")this.Left = leftthis.Right = rightthis.ConvertedLeft = convertedLeftthis.ConvertedRight = convertedRightthis.OperatorKind = operatorKindthis.Operators = operators
    }
  ...
  internal sealed partial class BoundUserDefinedConditionalLogicalOperator
  {
    ...
    BoundKind.UserDefinedConditionalLogicalOperator, syntax, type, hasErrors || left.HasErrors() || right.HasErrors(){
      ...
      Debug.Assert(type != null, "Field 'type' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")this.OperatorKind = operatorKindthis.Left = leftthis.Right = rightthis.LogicalOperator = logicalOperatorthis.TrueOperator = trueOperatorthis.FalseOperator = falseOperatorthis.ResultKind = resultKind
    }
  ...
  internal sealed partial class BoundCompoundAssignmentOperator
  {
    ...
    BoundKind.CompoundAssignmentOperator, syntax, type, hasErrors || left.HasErrors() || right.HasErrors(){
      Debug.Assert(left != null, "Field 'left' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")
      Debug.Assert(right != null, "Field 'right' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")
      Debug.Assert(type != null, "Field 'type' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")this.Operator = @operatorthis.Left = leftthis.Right = rightthis.LeftConversion = leftConversionthis.FinalConversion = finalConversionthis.ResultKind = resultKind
    }
  ...
  internal sealed partial class BoundAssignmentOperator
  {
    ...
    BoundKind.AssignmentOperator, syntax, type, hasErrors || left.HasErrors() || right.HasErrors(){
      Debug.Assert(left != null, "Field 'left' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")this.Left = leftthis.Right = rightthis.IsRef = isRef
    }
  ...
  internal sealed partial class BoundDeconstructionAssignmentOperator
  {
    ...
    BoundKind.DeconstructionAssignmentOperator, syntax, type, hasErrors || left.HasErrors() || right.HasErrors(){
      Debug.Assert(left != null, "Field 'left' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")
      Debug.Assert(right != null, "Field 'right' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")
      Debug.Assert(type != null, "Field 'type' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")this.Left = leftthis.Right = rightthis.IsUsed = isUsed
    }
  ...
  internal sealed partial class BoundNullCoalescingOperator
  {
    ...
    BoundKind.NullCoalescingOperator, syntax, type, hasErrors || leftOperand.HasErrors() || rightOperand.HasErrors(){
      ...
      Debug.Assert(rightOperand != null, "Field 'rightOperand' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")this.LeftOperand = leftOperandthis.RightOperand = rightOperandthis.LeftConversion = leftConversion
    }
  ...
  internal sealed partial class BoundConditionalOperator
  {
    ...
    BoundKind.ConditionalOperator, syntax, type, hasErrors || condition.HasErrors() || consequence.HasErrors() || alternative.HasErrors(){
      ...
      Debug.Assert(type != null, "Field 'type' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")this.IsRef = isRefthis.Condition = conditionthis.Consequence = consequencethis.Alternative = alternativethis.ConstantValueOpt = constantValueOpt
    }
  ...
  internal sealed partial class BoundArrayAccess
  {
    ...
    BoundKind.ArrayAccess, syntax, type, hasErrors || expression.HasErrors() || indices.HasErrors(){
      ...
      Debug.Assert(type != null, "Field 'type' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")this.Expression = expressionthis.Indices = indices
    }
  ...
  internal sealed partial class BoundArrayLength
  {
    ...
    BoundKind.ArrayLength, syntax, type, hasErrors || expression.HasErrors(){
      Debug.Assert(expression != null, "Field 'expression' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")
      Debug.Assert(type != null, "Field 'type' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")this.Expression = expression
    }
    public  BoundExpression Expression { get; }public override BoundNode Accept(BoundTreeVisitor visitor)
  ...
  internal sealed partial class BoundAwaitExpression
  {
    ...
    BoundKind.AwaitExpression, syntax, type, hasErrors || expression.HasErrors(){
      Debug.Assert(expression != null, "Field 'expression' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")
      Debug.Assert(type != null, "Field 'type' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")this.Expression = expressionthis.GetAwaiter = getAwaiterthis.IsCompleted = isCompletedthis.GetResult = getResult
    }
  ...
  internal abstract partial class BoundTypeOf
  {
    ...
    kind, syntax, type, hasErrors{
      Debug.Assert(type != null, "Field 'type' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")this.GetTypeFromHandle = getTypeFromHandle
    }
  ...
  internal sealed partial class BoundTypeOfOperator
  {
    ...
    BoundKind.TypeOfOperator, syntax, getTypeFromHandle, type, hasErrors || sourceType.HasErrors(){
      ...
      Debug.Assert(type != null, "Field 'type' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")this.SourceType = sourceType
    }
  ...
  internal sealed partial class BoundMethodDefIndex
  {
    ...
    BoundKind.MethodDefIndex, syntax, type, hasErrors{
      ...
      Debug.Assert(type != null, "Field 'type' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")this.Method = method
    }
  ...
  internal sealed partial class BoundInstrumentationPayloadRoot
  {
    ...
    BoundKind.InstrumentationPayloadRoot, syntax, type, hasErrors{
      Debug.Assert(type != null, "Field 'type' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")this.AnalysisKind = analysisKind
    }
  ...
  internal sealed partial class BoundSourceDocumentIndex
  {
    ...
    BoundKind.SourceDocumentIndex, syntax, type, hasErrors{
      ...
      Debug.Assert(type != null, "Field 'type' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")this.Document = document
    }
  ...
  internal sealed partial class BoundMethodInfo
  {
    ...
    BoundKind.MethodInfo, syntax, type, hasErrors{
      Debug.Assert(method != null, "Field 'method' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")
      Debug.Assert(type != null, "Field 'type' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")this.Method = methodthis.GetMethodFromHandle = getMethodFromHandle
    }
  ...
  internal sealed partial class BoundFieldInfo
  {
    ...
    BoundKind.FieldInfo, syntax, type, hasErrors{
      Debug.Assert(field != null, "Field 'field' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")
      Debug.Assert(type != null, "Field 'type' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")this.Field = fieldthis.GetFieldFromHandle = getFieldFromHandle
    }
    ...
    BoundKind.FieldInfo, syntax, type{
      Debug.Assert(field != null, "Field 'field' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")
      Debug.Assert(type != null, "Field 'type' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")this.Field = field;
  ...
  internal sealed partial class BoundIsOperator
  {
    ...
    BoundKind.IsOperator, syntax, type, hasErrors || operand.HasErrors() || targetType.HasErrors(){
      ...
      Debug.Assert(type != null, "Field 'type' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")this.Operand = operandthis.TargetType = targetTypethis.Conversion = conversion
    }
  ...
  internal sealed partial class BoundSizeOfOperator
  {
    ...
    BoundKind.SizeOfOperator, syntax, type, hasErrors || sourceType.HasErrors(){
      Debug.Assert(sourceType != null, "Field 'sourceType' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")
      Debug.Assert(type != null, "Field 'type' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")this.SourceType = sourceTypethis.ConstantValueOpt = constantValueOpt
    }
  ...
  internal sealed partial class BoundConversion
  {
    ...
    BoundKind.Conversion, syntax, type, hasErrors || operand.HasErrors(){
      Debug.Assert(operand != null, "Field 'operand' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")
      Debug.Assert(type != null, "Field 'type' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")this.Operand = operandthis.Conversion = conversionthis.IsBaseConversion = isBaseConversionthis.Checked = @checkedthis.ExplicitCastInCode = explicitCastInCodethis.ConstantValueOpt = constantValueOpt
    }
  ...
  internal sealed partial class BoundArgListOperator
  {
    ...
    BoundKind.ArgListOperator, syntax, type, hasErrors || arguments.HasErrors(){
      Debug.Assert(!arguments.IsDefault, "Field 'arguments' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")this.Arguments = argumentsthis.ArgumentRefKindsOpt = argumentRefKindsOpt
    }
  ...
  internal sealed partial class BoundFixedLocalCollectionInitializer
  {
    ...
    BoundKind.FixedLocalCollectionInitializer, syntax, type, hasErrors || expression.HasErrors(){
      ...
      Debug.Assert(expression != null, "Field 'expression' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")
      Debug.Assert(type != null, "Field 'type' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")this.ElementPointerType = elementPointerTypethis.ElementPointerTypeConversion = elementPointerTypeConversionthis.Expression = expressionthis.GetPinnableOpt = getPinnableOpt
    }
  ...
  internal sealed partial class BoundBlock
  {
    ...
    BoundKind.Block, syntax, statements, hasErrors || statements.HasErrors(){
      ...
      Debug.Assert(!statements.IsDefault, "Field 'statements' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")this.Locals = localsthis.LocalFunctions = localFunctions
    }
  ...
  internal sealed partial class BoundScope
  {
    ...
    BoundKind.Scope, syntax, statements, hasErrors || statements.HasErrors(){
      Debug.Assert(!locals.IsDefault, "Field 'locals' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")
      Debug.Assert(!statements.IsDefault, "Field 'statements' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")this.Locals = locals
    }
  ...
  internal sealed partial class BoundStateMachineScope
  {
    ...
    BoundKind.StateMachineScope, syntax, hasErrors || statement.HasErrors(){
      ...
      Debug.Assert(statement != null, "Field 'statement' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")this.Fields = fieldsthis.Statement = statement
    }
  ...
  internal sealed partial class BoundLocalDeclaration
  {
    ...
    BoundKind.LocalDeclaration, syntax, hasErrors || declaredType.HasErrors() || initializerOpt.HasErrors() || argumentsOpt.HasErrors(){
      ...
      Debug.Assert(declaredType != null, "Field 'declaredType' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")this.LocalSymbol = localSymbolthis.DeclaredType = declaredTypethis.InitializerOpt = initializerOptthis.ArgumentsOpt = argumentsOpt
    }
  ...
  internal sealed partial class BoundMultipleLocalDeclarations
  {
    ...
    BoundKind.MultipleLocalDeclarations, syntax, hasErrors || localDeclarations.HasErrors(){
      Debug.Assert(!localDeclarations.IsDefault, "Field 'localDeclarations' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")this.LocalDeclarations = localDeclarations
    }
  ...
  internal sealed partial class BoundLocalFunctionStatement
  {
    ...
    BoundKind.LocalFunctionStatement, syntax, hasErrors || blockBody.HasErrors() || expressionBody.HasErrors(){
      Debug.Assert(symbol != null, "Field 'symbol' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")this.Symbol = symbolthis.BlockBody = blockBodythis.ExpressionBody = expressionBody
    }
  ...
  internal sealed partial class BoundSequence
  {
    ...
    BoundKind.Sequence, syntax, type, hasErrors || sideEffects.HasErrors() || value.HasErrors(){
      ...
      Debug.Assert(type != null, "Field 'type' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")this.Locals = localsthis.SideEffects = sideEffectsthis.Value = value
    }
  ...
  internal sealed partial class BoundSwitchStatement
  {
    ...
    BoundKind.SwitchStatement, syntax, hasErrors || loweredPreambleOpt.HasErrors() || expression.HasErrors() || switchSections.HasErrors(){
      ...
      Debug.Assert(breakLabel != null, "Field 'breakLabel' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")this.LoweredPreambleOpt = loweredPreambleOptthis.Expression = expressionthis.ConstantTargetOpt = constantTargetOptthis.InnerLocals = innerLocalsthis.InnerLocalFunctions = innerLocalFunctionsthis.SwitchSections = switchSectionsthis.BreakLabel = breakLabelthis.StringEquality = stringEquality
    }
  ...
  internal sealed partial class BoundSwitchSection
  {
    ...
    BoundKind.SwitchSection, syntax, statements, hasErrors || switchLabels.HasErrors() || statements.HasErrors(){
      ...
      Debug.Assert(!statements.IsDefault, "Field 'statements' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")this.Locals = localsthis.SwitchLabels = switchLabels
    }
  ...
  internal sealed partial class BoundSwitchLabel
  {
    ...
    BoundKind.SwitchLabel, syntax, hasErrors || expressionOpt.HasErrors(){
      Debug.Assert(label != null, "Field 'label' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")this.Label = labelthis.ExpressionOpt = expressionOptthis.ConstantValueOpt = constantValueOpt
    }
  ...
  internal sealed partial class BoundBreakStatement
  {
    ...
    BoundKind.BreakStatement, syntax, hasErrors{
      Debug.Assert(label != null, "Field 'label' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")this.Label = label
    }
  ...
  internal sealed partial class BoundPatternSwitchStatement
  {
    ...
    BoundKind.PatternSwitchStatement, syntax, hasErrors || expression.HasErrors() || switchSections.HasErrors() || defaultLabel.HasErrors(){
      ...
      Debug.Assert(binder != null, "Field 'binder' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")this.Expression = expressionthis.SomeLabelAlwaysMatches = someLabelAlwaysMatchesthis.InnerLocals = innerLocalsthis.InnerLocalFunctions = innerLocalFunctionsthis.SwitchSections = switchSectionsthis.DefaultLabel = defaultLabelthis.BreakLabel = breakLabelthis.Binder = binderthis.IsComplete = isComplete
    }
  ...
  internal sealed partial class BoundPatternSwitchLabel
  {
    ...
    BoundKind.PatternSwitchLabel, syntax, hasErrors || pattern.HasErrors() || guard.HasErrors(){
      ...
      Debug.Assert(pattern != null, "Field 'pattern' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")this.Label = labelthis.Pattern = patternthis.Guard = guardthis.IsReachable = isReachable
    }
  ...
  internal sealed partial class BoundIfStatement
  {
    ...
    BoundKind.IfStatement, syntax, hasErrors || condition.HasErrors() || consequence.HasErrors() || alternativeOpt.HasErrors(){
      Debug.Assert(condition != null, "Field 'condition' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")
      Debug.Assert(consequence != null, "Field 'consequence' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")this.Condition = conditionthis.Consequence = consequencethis.AlternativeOpt = alternativeOpt
    }
  ...
  internal abstract partial class BoundLoopStatement
  {
    ...
    kind, syntax, hasErrors{
      Debug.Assert(breakLabel != null, "Field 'breakLabel' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")
      Debug.Assert(continueLabel != null, "Field 'continueLabel' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")this.BreakLabel = breakLabelthis.ContinueLabel = continueLabel
    }
    ...
    kind, syntax{
      Debug.Assert(breakLabel != null, "Field 'breakLabel' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")
      Debug.Assert(continueLabel != null, "Field 'continueLabel' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")this.BreakLabel = breakLabel;
      this.ContinueLabel = continueLabel;

    }
    public  GeneratedLabelSymbol BreakLabel { get; }public  GeneratedLabelSymbol ContinueLabel { get; }
  }
  internal sealed partial class BoundDoStatement
  {
    ...
    BoundKind.DoStatement, syntax, breakLabel, continueLabel, hasErrors || condition.HasErrors() || body.HasErrors(){
      ...
      Debug.Assert(breakLabel != null, "Field 'breakLabel' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")
      Debug.Assert(continueLabel != null, "Field 'continueLabel' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")this.Locals = localsthis.Condition = conditionthis.Body = body
    }
  ...
  internal sealed partial class BoundForStatement
  {
    ...
    BoundKind.ForStatement, syntax, breakLabel, continueLabel, hasErrors || initializer.HasErrors() || condition.HasErrors() || increment.HasErrors() || body.HasErrors(){
      ...
      Debug.Assert(body != null, "Field 'body' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")
      Debug.Assert(breakLabel != null, "Field 'breakLabel' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")
      Debug.Assert(continueLabel != null, "Field 'continueLabel' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")this.OuterLocals = outerLocalsthis.Initializer = initializerthis.InnerLocals = innerLocalsthis.Condition = conditionthis.Increment = incrementthis.Body = body
    }
  ...
  internal sealed partial class BoundForEachStatement
  {
    ...
    BoundKind.ForEachStatement, syntax, breakLabel, continueLabel, hasErrors || iterationVariableType.HasErrors() || iterationErrorExpressionOpt.HasErrors() || expression.HasErrors() || deconstructionOpt.HasErrors() || body.HasErrors(){
      ...
      Debug.Assert(body != null, "Field 'body' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")
      Debug.Assert(breakLabel != null, "Field 'breakLabel' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")
      Debug.Assert(continueLabel != null, "Field 'continueLabel' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")this.EnumeratorInfoOpt = enumeratorInfoOptthis.ElementConversion = elementConversionthis.IterationVariableType = iterationVariableTypethis.IterationVariables = iterationVariablesthis.IterationErrorExpressionOpt = iterationErrorExpressionOptthis.Expression = expressionthis.DeconstructionOpt = deconstructionOptthis.Body = bodythis.Checked = @checked
    }
  ...
  internal sealed partial class BoundForEachDeconstructStep
  {
    ...
    BoundKind.ForEachDeconstructStep, syntax, hasErrors || deconstructionAssignment.HasErrors() || targetPlaceholder.HasErrors(){
      ...
      Debug.Assert(targetPlaceholder != null, "Field 'targetPlaceholder' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")this.DeconstructionAssignment = deconstructionAssignmentthis.TargetPlaceholder = targetPlaceholder
    }
  ...
  internal sealed partial class BoundUsingStatement
  {
    ...
    BoundKind.UsingStatement, syntax, hasErrors || declarationsOpt.HasErrors() || expressionOpt.HasErrors() || body.HasErrors(){
      Debug.Assert(!locals.IsDefault, "Field 'locals' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")
      Debug.Assert(body != null, "Field 'body' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")this.Locals = localsthis.DeclarationsOpt = declarationsOptthis.ExpressionOpt = expressionOptthis.IDisposableConversion = iDisposableConversionthis.Body = body
    }
  ...
  internal sealed partial class BoundFixedStatement
  {
    ...
    BoundKind.FixedStatement, syntax, hasErrors || declarations.HasErrors() || body.HasErrors(){
      ...
      Debug.Assert(body != null, "Field 'body' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")this.Locals = localsthis.Declarations = declarationsthis.Body = body
    }
  ...
  internal sealed partial class BoundLockStatement
  {
    ...
    BoundKind.LockStatement, syntax, hasErrors || argument.HasErrors() || body.HasErrors(){
      ...
      Debug.Assert(body != null, "Field 'body' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")this.Argument = argumentthis.Body = body
    }
  ...
  internal sealed partial class BoundTryStatement
  {
    ...
    BoundKind.TryStatement, syntax, hasErrors || tryBlock.HasErrors() || catchBlocks.HasErrors() || finallyBlockOpt.HasErrors(){
      ...
      Debug.Assert(!catchBlocks.IsDefault, "Field 'catchBlocks' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")this.TryBlock = tryBlockthis.CatchBlocks = catchBlocksthis.FinallyBlockOpt = finallyBlockOptthis.PreferFaultHandler = preferFaultHandler
    }
  ...
  internal sealed partial class BoundCatchBlock
  {
    ...
    BoundKind.CatchBlock, syntax, hasErrors || exceptionSourceOpt.HasErrors() || exceptionFilterOpt.HasErrors() || body.HasErrors(){
      Debug.Assert(!locals.IsDefault, "Field 'locals' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")
      Debug.Assert(body != null, "Field 'body' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")this.Locals = localsthis.ExceptionSourceOpt = exceptionSourceOptthis.ExceptionTypeOpt = exceptionTypeOptthis.ExceptionFilterOpt = exceptionFilterOptthis.Body = bodythis.IsSynthesizedAsyncCatchAll = isSynthesizedAsyncCatchAll
    }
  ...
  internal sealed partial class BoundLocal
  {
    ...
    BoundKind.Local, syntax, type, hasErrors{
      Debug.Assert(localSymbol != null, "Field 'localSymbol' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")
      Debug.Assert(type != null, "Field 'type' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")this.LocalSymbol = localSymbolthis.IsDeclaration = isDeclarationthis.ConstantValueOpt = constantValueOpt
    }
    ...
    BoundKind.Local, syntax, type{
      Debug.Assert(localSymbol != null, "Field 'localSymbol' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")
      Debug.Assert(type != null, "Field 'type' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")this.LocalSymbol = localSymbol;
  ...
  internal sealed partial class BoundPseudoVariable
  {
    ...
    BoundKind.PseudoVariable, syntax, type, hasErrors{
      ...
      Debug.Assert(type != null, "Field 'type' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")this.LocalSymbol = localSymbolthis.EmitExpressions = emitExpressions
    }
  ...
  internal sealed partial class BoundRangeVariable
  {
    ...
    BoundKind.RangeVariable, syntax, type, hasErrors || value.HasErrors(){
      ...
      Debug.Assert(value != null, "Field 'value' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")
      Debug.Assert(type != null, "Field 'type' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")this.RangeVariableSymbol = rangeVariableSymbolthis.Value = value
    }
  ...
  internal sealed partial class BoundParameter
  {
    ...
    BoundKind.Parameter, syntax, type, hasErrors{
      ...
      Debug.Assert(type != null, "Field 'type' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")this.ParameterSymbol = parameterSymbol
    }
  ...
  internal sealed partial class BoundGotoStatement
  {
    ...
    BoundKind.GotoStatement, syntax, hasErrors || caseExpressionOpt.HasErrors() || labelExpressionOpt.HasErrors(){
      Debug.Assert(label != null, "Field 'label' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")this.Label = labelthis.CaseExpressionOpt = caseExpressionOptthis.LabelExpressionOpt = labelExpressionOpt
    }
  ...
  internal sealed partial class BoundLabeledStatement
  {
    ...
    BoundKind.LabeledStatement, syntax, hasErrors || body.HasErrors(){
      Debug.Assert(label != null, "Field 'label' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")
      Debug.Assert(body != null, "Field 'body' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")this.Label = labelthis.Body = body
    }
  ...
  internal partial class BoundStatementList
  {
    ...
    kind, syntax, hasErrors{
      Debug.Assert(!statements.IsDefault, "Field 'statements' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")this.Statements = statements
    }
  ...
  internal sealed partial class BoundConditionalGoto
  {
    ...
    BoundKind.ConditionalGoto, syntax, hasErrors || condition.HasErrors(){
      Debug.Assert(condition != null, "Field 'condition' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")
      Debug.Assert(label != null, "Field 'label' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")this.Condition = conditionthis.JumpIfTrue = jumpIfTruethis.Label = label
    }
  ...
  internal abstract partial class BoundMethodOrPropertyGroup
  {
    ...
    public  BoundExpression ReceiverOpt { get; }public override LookupResultKind ResultKind { get; }
  }
  internal sealed partial class BoundDynamicMemberAccess
  {
    ...
    BoundKind.DynamicMemberAccess, syntax, type, hasErrors || receiver.HasErrors(){
      ...
      Debug.Assert(type != null, "Field 'type' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")this.Receiver = receiverthis.TypeArgumentsOpt = typeArgumentsOptthis.Name = namethis.Invoked = invokedthis.Indexed = indexed
    }
  ...
  internal sealed partial class BoundDynamicInvocation
  {
    ...
    BoundKind.DynamicInvocation, syntax, type, hasErrors || expression.HasErrors() || arguments.HasErrors(){
      ...
      Debug.Assert(type != null, "Field 'type' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")this.Expression = expressionthis.Arguments = argumentsthis.ArgumentNamesOpt = argumentNamesOptthis.ArgumentRefKindsOpt = argumentRefKindsOptthis.ApplicableMethods = applicableMethods
    }
  ...
  internal sealed partial class BoundConditionalAccess
  {
    ...
    BoundKind.ConditionalAccess, syntax, type, hasErrors || receiver.HasErrors() || accessExpression.HasErrors(){
      ...
      Debug.Assert(type != null, "Field 'type' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")this.Receiver = receiverthis.AccessExpression = accessExpression
    }
  ...
  internal sealed partial class BoundLoweredConditionalAccess
  {
    ...
    BoundKind.LoweredConditionalAccess, syntax, type, hasErrors || receiver.HasErrors() || whenNotNull.HasErrors() || whenNullOpt.HasErrors(){
      ...
      Debug.Assert(type != null, "Field 'type' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")this.Receiver = receiverthis.HasValueMethodOpt = hasValueMethodOptthis.WhenNotNull = whenNotNullthis.WhenNullOpt = whenNullOptthis.Id = id
    }
  ...
  internal sealed partial class BoundConditionalReceiver
  {
    ...
    BoundKind.ConditionalReceiver, syntax, type, hasErrors{
      Debug.Assert(type != null, "Field 'type' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")this.Id = id
    }
  ...
  internal sealed partial class BoundComplexConditionalReceiver
  {
    ...
    BoundKind.ComplexConditionalReceiver, syntax, type, hasErrors || valueTypeReceiver.HasErrors() || referenceTypeReceiver.HasErrors(){
      ...
      Debug.Assert(type != null, "Field 'type' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")this.ValueTypeReceiver = valueTypeReceiverthis.ReferenceTypeReceiver = referenceTypeReceiver
    }
  ...
  internal sealed partial class BoundMethodGroup
  {
    ...
    BoundKind.MethodGroup, syntax, receiverOpt, resultKind, hasErrors || receiverOpt.HasErrors(){
      Debug.Assert(name != null, "Field 'name' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")
      Debug.Assert(!methods.IsDefault, "Field 'methods' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")this.TypeArgumentsOpt = typeArgumentsOptthis.Name = namethis.Methods = methodsthis.LookupSymbolOpt = lookupSymbolOptthis.LookupError = lookupErrorthis.Flags = flags
    }
  ...
  internal sealed partial class BoundPropertyGroup
  {
    ...
    BoundKind.PropertyGroup, syntax, receiverOpt, resultKind, hasErrors || receiverOpt.HasErrors(){
      Debug.Assert(!properties.IsDefault, "Field 'properties' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")this.Properties = properties
    }
  ...
  internal sealed partial class BoundEventAssignmentOperator
  {
    ...
    BoundKind.EventAssignmentOperator, syntax, type, hasErrors || receiverOpt.HasErrors() || argument.HasErrors(){
      ...
      Debug.Assert(argument != null, "Field 'argument' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")
      Debug.Assert(type != null, "Field 'type' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")this.Event = @eventthis.IsAddition = isAdditionthis.IsDynamic = isDynamicthis.ReceiverOpt = receiverOptthis.Argument = argument
    }
  ...
  internal sealed partial class BoundAttribute
  {
    ...
    BoundKind.Attribute, syntax, type, hasErrors || constructorArguments.HasErrors() || namedArguments.HasErrors(){
      ...
      Debug.Assert(type != null, "Field 'type' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")this.Constructor = constructorthis.ConstructorArguments = constructorArgumentsthis.ConstructorArgumentNamesOpt = constructorArgumentNamesOptthis.NamedArguments = namedArgumentsthis.ResultKind = resultKind
    }
  ...
  internal sealed partial class BoundObjectCreationExpression
  {
    ...
    BoundKind.ObjectCreationExpression, syntax, type, hasErrors || arguments.HasErrors() || initializerExpressionOpt.HasErrors(){
      ...
      Debug.Assert(!arguments.IsDefault, "Field 'arguments' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")
      Debug.Assert(type != null, "Field 'type' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")this.Constructor = constructorthis.ConstructorsGroup = constructorsGroupthis.Arguments = argumentsthis.ArgumentNamesOpt = argumentNamesOptthis.ArgumentRefKindsOpt = argumentRefKindsOptthis.Expanded = expandedthis.ArgsToParamsOpt = argsToParamsOptthis.ConstantValueOpt = constantValueOptthis.InitializerExpressionOpt = initializerExpressionOptthis.BinderOpt = binderOpt
    }
  ...
  internal abstract partial class BoundTupleExpression
  {
    ...
    kind, syntax, type, hasErrors{
      Debug.Assert(!arguments.IsDefault, "Field 'arguments' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")this.Arguments = arguments
    }
    public  ImmutableArray<BoundExpression> Arguments { get; }
  }
  internal sealed partial class BoundTupleLiteral
  {
    ...
    BoundKind.TupleLiteral, syntax, arguments, type, hasErrors || arguments.HasErrors(){
      Debug.Assert(!arguments.IsDefault, "Field 'arguments' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")this.ArgumentNamesOpt = argumentNamesOptthis.InferredNamesOpt = inferredNamesOpt
    }
  ...
  internal sealed partial class BoundConvertedTupleLiteral
  {
    ...
    BoundKind.ConvertedTupleLiteral, syntax, arguments, type, hasErrors || arguments.HasErrors(){
      Debug.Assert(!arguments.IsDefault, "Field 'arguments' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")
      Debug.Assert(type != null, "Field 'type' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")this.NaturalTypeOpt = naturalTypeOpt
    }
  ...
  internal sealed partial class BoundDynamicObjectCreationExpression
  {
    ...
    BoundKind.DynamicObjectCreationExpression, syntax, type, hasErrors || arguments.HasErrors() || initializerExpressionOpt.HasErrors(){
      ...
      Debug.Assert(!arguments.IsDefault, "Field 'arguments' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")
      Debug.Assert(!applicableMethods.IsDefault, "Field 'applicableMethods' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")
      Debug.Assert(type != null, "Field 'type' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")this.Name = namethis.Arguments = argumentsthis.ArgumentNamesOpt = argumentNamesOptthis.ArgumentRefKindsOpt = argumentRefKindsOptthis.InitializerExpressionOpt = initializerExpressionOptthis.ApplicableMethods = applicableMethods
    }
  ...
  internal sealed partial class BoundNoPiaObjectCreationExpression
  {
    ...
    BoundKind.NoPiaObjectCreationExpression, syntax, type, hasErrors || initializerExpressionOpt.HasErrors(){
      Debug.Assert(type != null, "Field 'type' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")this.GuidString = guidStringthis.InitializerExpressionOpt = initializerExpressionOpt
    }
  ...
  internal abstract partial class BoundObjectInitializerExpressionBase
  {
    ...
    kind, syntax, type, hasErrors{
      ...
      Debug.Assert(type != null, "Field 'type' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")this.Initializers = initializers
    }
  ...
  internal sealed partial class BoundObjectInitializerMember
  {
    ...
    BoundKind.ObjectInitializerMember, syntax, type, hasErrors || arguments.HasErrors(){
      ...
      Debug.Assert(type != null, "Field 'type' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")this.MemberSymbol = memberSymbolthis.Arguments = argumentsthis.ArgumentNamesOpt = argumentNamesOptthis.ArgumentRefKindsOpt = argumentRefKindsOptthis.Expanded = expandedthis.ArgsToParamsOpt = argsToParamsOptthis.ResultKind = resultKindthis.ReceiverType = receiverTypethis.BinderOpt = binderOpt
    }
  ...
  internal sealed partial class BoundDynamicObjectInitializerMember
  {
    ...
    BoundKind.DynamicObjectInitializerMember, syntax, type, hasErrors{
      ...
      Debug.Assert(receiverType != null, "Field 'receiverType' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")
      Debug.Assert(type != null, "Field 'type' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")this.MemberName = memberNamethis.ReceiverType = receiverType
    }
    ...
    BoundKind.DynamicObjectInitializerMember, syntax, type{
      Debug.Assert(memberName != null, "Field 'memberName' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")
      Debug.Assert(receiverType != null, "Field 'receiverType' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")
      Debug.Assert(type != null, "Field 'type' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")this.MemberName = memberName;
  ...
  internal sealed partial class BoundCollectionElementInitializer
  {
    ...
    BoundKind.CollectionElementInitializer, syntax, type, hasErrors || arguments.HasErrors() || implicitReceiverOpt.HasErrors(){
      ...
      Debug.Assert(!arguments.IsDefault, "Field 'arguments' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")
      Debug.Assert(type != null, "Field 'type' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")this.AddMethod = addMethodthis.Arguments = argumentsthis.ImplicitReceiverOpt = implicitReceiverOptthis.Expanded = expandedthis.ArgsToParamsOpt = argsToParamsOptthis.InvokedAsExtensionMethod = invokedAsExtensionMethodthis.ResultKind = resultKindthis.BinderOpt = binderOpt
    }
  ...
  internal sealed partial class BoundDynamicCollectionElementInitializer
  {
    ...
    BoundKind.DynamicCollectionElementInitializer, syntax, type, hasErrors || arguments.HasErrors() || implicitReceiver.HasErrors(){
      ...
      Debug.Assert(!applicableMethods.IsDefault, "Field 'applicableMethods' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")
      Debug.Assert(type != null, "Field 'type' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")this.Arguments = argumentsthis.ImplicitReceiver = implicitReceiverthis.ApplicableMethods = applicableMethods
    }
  ...
  internal sealed partial class BoundAnonymousObjectCreationExpression
  {
    ...
    BoundKind.AnonymousObjectCreationExpression, syntax, type, hasErrors || arguments.HasErrors() || declarations.HasErrors(){
      ...
      Debug.Assert(type != null, "Field 'type' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")this.Constructor = constructorthis.Arguments = argumentsthis.Declarations = declarations
    }
  ...
  internal sealed partial class BoundAnonymousPropertyDeclaration
  {
    ...
    BoundKind.AnonymousPropertyDeclaration, syntax, type, hasErrors{
      Debug.Assert(property != null, "Field 'property' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")
      Debug.Assert(type != null, "Field 'type' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")this.Property = property
    }
  ...
  internal sealed partial class BoundNewT
  {
    ...
    BoundKind.NewT, syntax, type, hasErrors || initializerExpressionOpt.HasErrors(){
      Debug.Assert(type != null, "Field 'type' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")this.InitializerExpressionOpt = initializerExpressionOpt
    }
  ...
  internal sealed partial class BoundDelegateCreationExpression
  {
    ...
    BoundKind.DelegateCreationExpression, syntax, type, hasErrors || argument.HasErrors(){
      Debug.Assert(argument != null, "Field 'argument' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")
      Debug.Assert(type != null, "Field 'type' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")this.Argument = argumentthis.MethodOpt = methodOptthis.IsExtensionMethod = isExtensionMethod
    }
  ...
  internal sealed partial class BoundArrayCreation
  {
    ...
    BoundKind.ArrayCreation, syntax, type, hasErrors || bounds.HasErrors() || initializerOpt.HasErrors(){
      ...
      Debug.Assert(type != null, "Field 'type' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")this.Bounds = boundsthis.InitializerOpt = initializerOpt
    }
  ...
  internal sealed partial class BoundArrayInitialization
  {
    ...
    BoundKind.ArrayInitialization, syntax, null, hasErrors || initializers.HasErrors(){
      Debug.Assert(!initializers.IsDefault, "Field 'initializers' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")this.Initializers = initializers
    }
  ...
  internal partial class BoundStackAllocArrayCreation
  {
    ...
    kind, syntax, type, hasErrors{
      ...
      Debug.Assert(count != null, "Field 'count' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")this.ElementType = elementTypethis.Count = countthis.InitializerOpt = initializerOpt
    }
  ...
  internal sealed partial class BoundFieldAccess
  {
    ...
    BoundKind.FieldAccess, syntax, type, hasErrors || receiverOpt.HasErrors(){
      ...
      Debug.Assert(type != null, "Field 'type' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")this.ReceiverOpt = receiverOptthis.FieldSymbol = fieldSymbolthis.ConstantValueOpt = constantValueOptthis.ResultKind = resultKindthis.IsByValue = isByValuethis.IsDeclaration = isDeclaration
    }
  ...
  internal sealed partial class BoundHoistedFieldAccess
  {
    ...
    BoundKind.HoistedFieldAccess, syntax, type, hasErrors{
      Debug.Assert(fieldSymbol != null, "Field 'fieldSymbol' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")
      Debug.Assert(type != null, "Field 'type' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")this.FieldSymbol = fieldSymbol
    }
  ...
  internal sealed partial class BoundPropertyAccess
  {
    ...
    BoundKind.PropertyAccess, syntax, type, hasErrors || receiverOpt.HasErrors(){
      ...
      Debug.Assert(type != null, "Field 'type' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")this.ReceiverOpt = receiverOptthis.PropertySymbol = propertySymbolthis.ResultKind = resultKind
    }
  ...
  internal sealed partial class BoundEventAccess
  {
    ...
    BoundKind.EventAccess, syntax, type, hasErrors || receiverOpt.HasErrors(){
      ...
      Debug.Assert(type != null, "Field 'type' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")this.ReceiverOpt = receiverOptthis.EventSymbol = eventSymbolthis.IsUsableAsField = isUsableAsFieldthis.ResultKind = resultKind
    }
  ...
  internal sealed partial class BoundIndexerAccess
  {
    ...
    BoundKind.IndexerAccess, syntax, type, hasErrors || receiverOpt.HasErrors() || arguments.HasErrors(){
      ...
      Debug.Assert(!arguments.IsDefault, "Field 'arguments' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")
      Debug.Assert(type != null, "Field 'type' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")this.ReceiverOpt = receiverOptthis.Indexer = indexerthis.Arguments = argumentsthis.ArgumentNamesOpt = argumentNamesOptthis.ArgumentRefKindsOpt = argumentRefKindsOptthis.Expanded = expandedthis.ArgsToParamsOpt = argsToParamsOptthis.BinderOpt = binderOptthis.UseSetterForDefaultArgumentGeneration = useSetterForDefaultArgumentGeneration
    }
  ...
  internal sealed partial class BoundDynamicIndexerAccess
  {
    ...
    BoundKind.DynamicIndexerAccess, syntax, type, hasErrors || receiverOpt.HasErrors() || arguments.HasErrors(){
      ...
      Debug.Assert(type != null, "Field 'type' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")this.ReceiverOpt = receiverOptthis.Arguments = argumentsthis.ArgumentNamesOpt = argumentNamesOptthis.ArgumentRefKindsOpt = argumentRefKindsOptthis.ApplicableIndexers = applicableIndexers
    }
  ...
  internal sealed partial class BoundLambda
  {
    ...
    BoundKind.Lambda, syntax, type, hasErrors || body.HasErrors(){
      ...
      Debug.Assert(binder != null, "Field 'binder' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")this.Symbol = symbolthis.Body = bodythis.Diagnostics = diagnosticsthis.Binder = binder
    }
  ...
  internal sealed partial class UnboundLambda
  {
    ...
    BoundKind.UnboundLambda, syntax, null, hasErrors{
      Debug.Assert(data != null, "Field 'data' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")this.Data = data
    }
  ...
  internal sealed partial class BoundQueryClause
  {
    ...
    BoundKind.QueryClause, syntax, type, hasErrors || value.HasErrors(){
      ...
      Debug.Assert(type != null, "Field 'type' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")this.Value = valuethis.DefinedSymbol = definedSymbolthis.Binder = binder
    }
  ...
  internal sealed partial class BoundNameOfOperator
  {
    ...
    BoundKind.NameOfOperator, syntax, type, hasErrors || argument.HasErrors(){
      ...
      Debug.Assert(type != null, "Field 'type' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")this.Argument = argumentthis.ConstantValueOpt = constantValueOpt
    }
  ...
  internal sealed partial class BoundInterpolatedString
  {
    ...
    BoundKind.InterpolatedString, syntax, type, hasErrors || parts.HasErrors(){
      Debug.Assert(!parts.IsDefault, "Field 'parts' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")this.Parts = parts
    }
  ...
  internal sealed partial class BoundStringInsert
  {
    ...
    BoundKind.StringInsert, syntax, type, hasErrors || value.HasErrors() || alignment.HasErrors() || format.HasErrors(){
      Debug.Assert(value != null, "Field 'value' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")this.Value = valuethis.Alignment = alignmentthis.Format = format
    }
  ...
  internal sealed partial class BoundIsPatternExpression
  {
    ...
    BoundKind.IsPatternExpression, syntax, type, hasErrors || expression.HasErrors() || pattern.HasErrors(){
      Debug.Assert(expression != null, "Field 'expression' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")
      Debug.Assert(pattern != null, "Field 'pattern' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")this.Expression = expressionthis.Pattern = pattern
    }
  ...
  internal sealed partial class BoundDeclarationPattern
  {
    ...
    BoundKind.DeclarationPattern, syntax, hasErrors || variableAccess.HasErrors() || declaredType.HasErrors(){
      Debug.Assert(variableAccess != null, "Field 'variableAccess' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")this.Variable = variablethis.VariableAccess = variableAccessthis.DeclaredType = declaredTypethis.IsVar = isVar
    }
  ...
  internal sealed partial class BoundConstantPattern
  {
    ...
    BoundKind.ConstantPattern, syntax, hasErrors || value.HasErrors(){
      Debug.Assert(value != null, "Field 'value' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")this.Value = valuethis.ConstantValue = constantValue
    }
  ...
  internal abstract partial class VariablePendingInference
  {
    ...
    kind, syntax, null, hasErrors{
      Debug.Assert(variableSymbol != null, "Field 'variableSymbol' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")this.VariableSymbol = variableSymbolthis.ReceiverOpt = receiverOpt
    }
    public  Symbol VariableSymbol { get; }public  BoundExpression ReceiverOpt { get; }
  }
  internal sealed partial class OutVariablePendingInference
  {
  ...
  internal abstract partial class BoundMethodBodyBase
  {
    ...
    public  BoundBlock BlockBody { get; }public  BoundBlock ExpressionBody { get; }
  }
  internal sealed partial class BoundNonConstructorMethodBody
  {
  ...
  internal sealed partial class BoundConstructorMethodBody
  {
    ...
    BoundKind.ConstructorMethodBody, syntax, blockBody, expressionBody, hasErrors || initializer.HasErrors() || blockBody.HasErrors() || expressionBody.HasErrors(){
      Debug.Assert(!locals.IsDefault, "Field 'locals' cannot be null (use Null=\"allow\" in BoundNodes.xml to remove this check)")this.Locals = localsthis.Initializer = initializer
    }

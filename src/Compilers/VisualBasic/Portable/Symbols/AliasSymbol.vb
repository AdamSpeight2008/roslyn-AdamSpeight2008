...
Namespace Microsoft.CodeAnalysis.VisualBasic.Symbols
  ...
  Friend NotInheritable Class AliasSymbol
    ...
    Friend Sub New(
      ...
      If merged IsNot Nothing Then sourceNs = merged.GetConstituentForCompilation(compilation)
    ...
    ''' <summary> Gets the kind of this symbol. </summary>
    ...
    ''' <summary> Gets the <see cref="NamespaceOrTypeSymbol"/> for the namespace or type referenced by the alias. </summary>
    ...
    ''' <summary> Gets the locations where this symbol was originally defined. </summary>
    ...
    Public Overrides Function GetHashCode() As Integer
        Return If(Locations.Length > 0, Locations(0).GetHashCode(), Me.Name.GetHashCode())
    End Function

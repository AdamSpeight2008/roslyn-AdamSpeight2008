...
Namespace Microsoft.CodeAnalysis.VisualBasic
    ...
    ''' <summary>Represents Visual Basic parse options.</summary>
    Public NotInheritable Class VisualBasicParseOptions
        ...
        ''' <summary>Creates an instance of VisualBasicParseOptions.</summary>
    ...
    preprocessorSymbols:=other._preprocessorSymbols,
        ...
        ''' <summary>The preprocessor symbols to parse with. </summary>
        ''' <remarks>May contain duplicate keys. The last one wins. </remarks>
        ...
        ''' <summary>Returns a collection of preprocessor symbol names. </summary>
        ...
        ''' <summary>Returns a VisualBasicParseOptions instance for a specified language version. </summary>
        ...
        Public Shadows Function WithLanguageVersion(version As LanguageVersion) As VisualBasicParseOptions
            If version = _specifiedLanguageVersion Then Return Me
        ...
        ''' <summary> Returns a VisualBasicParseOptions instance for a specified source code kind. </summary>
        ...
        Public Shadows Function WithKind(kind As SourceCodeKind) As VisualBasicParseOptions
            If kind = Me.SpecifiedKind Then Return Me
        ...
        ''' <summary> Returns a VisualBasicParseOptions instance for a specified documentation mode. </summary >
        ...
        Public Overloads Function WithDocumentationMode(documentationMode As DocumentationMode) As VisualBasicParseOptions
            If documentationMode = Me.DocumentationMode Then Return Me

            Return New VisualBasicParseOptions(Me) With {.DocumentationMode = documentationMode}
        End Function

        ''' <summary> Returns a VisualBasicParseOptions instance for a specified collection of KeyValuePairs representing pre-processor symbols. </summary>
        ...
        Public Shadows Function WithPreprocessorSymbols(symbols As ImmutableArray(Of KeyValuePair(Of String, Object))) As VisualBasicParseOptions
            ...
            If symbols.Equals(Me.PreprocessorSymbols) Then Return Me

            Return New VisualBasicParseOptions(Me) With {._preprocessorSymbols = symbols}
        End Function

        ''' <summary> Returns a ParseOptions instance for a specified Source Code Kind. </summary>
        ''' <param name="kind">The parser source code kind.</param>
        ...
        ''' <summary> Returns a ParseOptions instance for a specified Documentation Mode. </summary>
        ''' <param name="documentationMode">The documentation mode.</param>
        ''' <returns>A new instance of ParseOptions.</returns>
        ...
        ''' <summary> Enable some experimental language features for testing. </summary>
        Public Shadows Function WithFeatures(features As IEnumerable(Of KeyValuePair(Of String, String))) As VisualBasicParseOptions
            ...
            If features Is Nothing Then Return New VisualBasicParseOptions(Me) With {._features = ImmutableDictionary(Of String, String).Empty}
        ...
        Friend Overrides Sub ValidateOptions(builder As ArrayBuilder(Of Diagnostic))
            ...
            If Not LanguageVersion.IsValid Then builder.Add(Diagnostic.Create(MessageProvider.Instance, ERRID.ERR_BadLanguageVersion, LanguageVersion.ToString))

            If PreprocessorSymbols.IsDefaultOrEmpty Then Exit Sub

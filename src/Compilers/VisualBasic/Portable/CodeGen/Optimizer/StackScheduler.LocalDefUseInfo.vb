...
Namespace Microsoft.CodeAnalysis.VisualBasic.CodeGen
  ...
  Partial Friend Class StackScheduler
    ...
    Private Class LocalDefUseInfo
      ...
      ''' <summary> stack at variable declaration, may be > 0 in sequences. </summary>
      Public ReadOnly StackAtDeclaration As Integer

      ''' <summary> value definitions for this variable </summary>
      Public ReadOnly localDefs As New List(Of LocalDefUseSpan)(8)

      Private _cannotSchedule As Boolean = False

      ''' <summary> once this goes to true we are no longer interested in this variable. </summary>

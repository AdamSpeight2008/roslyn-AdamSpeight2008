...
Namespace Microsoft.CodeAnalysis.VisualBasic
    ...
    Friend NotInheritable Class AttributeSemanticModel
        ...
        Friend Shared Function Create(
                                       containingSemanticModel  As SyntaxTreeSemanticModel,
                                       binder                   As AttributeBinder,
                              Optional ignoreAccessibility      As Boolean = False
        ...
        ''' </summary>
        Friend Shared Function CreateSpeculative(
        ...
        Friend Overrides Function Bind(
                                        binder      As Binder,
                                        node        As SyntaxNode,
        ...
        Friend Overrides Function TryGetSpeculativeSemanticModelCore(
                                                                    parentModel As SyntaxTreeSemanticModel,
                                                                    position As Integer,
        ...
        Friend Overrides Function TryGetSpeculativeSemanticModelForMethodBodyCore(
                                                                                 parentModel As SyntaxTreeSemanticModel,
                                                                                 position As Integer,

...
Namespace Microsoft.CodeAnalysis.VisualBasic
    ...
    Friend Class Mutable_VBCommandLineArguments
        ...
        Friend debugInformationFormat As Microsoft.CodeAnalysis.Emit.DebugInformationFormat = If(PathUtilities.IsUnixLikePlatform,
                                                                                                Microsoft.CodeAnalysis.Emit.DebugInformationFormat.PortablePdb,
                                                                                                Microsoft.CodeAnalysis.Emit.DebugInformationFormat.Pdb)
        ...
        Friend languageVersion As Language.Version.LanguageVersionService.LanguageVersion = Language.Version.LanguageVersionService.LanguageVersion.VisualBasic14
        ...
        Friend preferredUILang As System.Globalization.CultureInfo = Nothing
        ...
        Friend instrumentationKinds As PooledObjects.ArrayBuilder(Of Microsoft.CodeAnalysis.Emit.InstrumentationKind) = PooledObjects.ArrayBuilder(Of Microsoft.CodeAnalysis.Emit.InstrumentationKind).GetInstance()
...
features:=parsedFeatures)
            ...
            Dim emitOptions = New Microsoft.CodeAnalysis.Emit.EmitOptions(
                metadataOnly:=False,

...
Namespace Microsoft.CodeAnalysis.VisualBasic
    ...
    Public Class VisualBasicCommandLineParser
        ...
        Public Shadows Function Parse(args As IEnumerable(Of String),
            ...
            If Not Me.IsScriptCommandLineParser Then
                For Each arg In q.flattenedArgs
                    ...
                    If TryParseOption(arg, name, value) AndAlso (name = "ruleset") Then
                        ...
                        q.ruleSetPath = ParseGenericPathToFile(unquoted, q.diagnostics, baseDirectory)
                        q.generalDiagnosticOption = GetDiagnosticOptionsFromRulesetFile(q.ruleSetPath, q.specificDiagnosticOptionsFromRuleSet, q.diagnostics)
                    End If
                Next
            End If
        ...
        Private Shared Function ARG_PreferredUILang(q As VisualBasicCommandLineArguments.Mutable_VBCommandLineArguments, name As String, value As String) As Boolean
            ...
            Else
                Try
                    ...
                    If (q.preferredUILang.CultureTypes And CultureTypes.UserCustomCulture) <> 0 Then
        ...
        Private Shared Function ARG_LangVersion(q As VisualBasicCommandLineArguments.Mutable_VBCommandLineArguments, value As String) As Boolean
            ...
            Else
                If String.IsNullOrEmpty(value) Then
                    AddDiagnostic(q.diagnostics, ERRID.ERR_ArgumentRequired, "langversion", ":<number>")
                ElseIf value = "?" Then
                    q.displayLangVersions = True
                ElseIf Not Language.Version.LanguageVersionService.Instance.TryParse(value, q.languageVersion) Then

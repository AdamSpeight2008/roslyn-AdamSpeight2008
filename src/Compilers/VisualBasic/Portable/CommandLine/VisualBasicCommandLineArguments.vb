...
Namespace Microsoft.CodeAnalysis.VisualBasic
  ...
  ''' <summary> The CommandLineArguments class provides members to Set and Get Visual Basic compilation and parse options. </summary>
  Public NotInheritable Class VisualBasicCommandLineArguments
      Inherits CommandLineArguments

      ''' <summary> Set and Get the Visual Basic compilation options. </summary>
      ...
      ''' <summary> Set and Get the Visual Basic parse options. </summary>
      ...
      ''' <summary> Gets the core Parse options. </summary>
      ...
      ''' <summary> Gets the core compilation options. </summary>
      ...
      Friend Overrides Function ResolveMetadataReferences(
        ...
        For Each reference In resolved
          If reference.IsUnresolved Then Continue For

...
Namespace Microsoft.CodeAnalysis.VisualBasic
  ...
  Friend NotInheritable Class MessageProvider
    ...
    Public Overrides Function GetDiagnosticReport(diagnosticInfo As DiagnosticInfo, options As CompilationOptions) As ReportDiagnostic
       ...
       Return VisualBasicDiagnosticFilter.GetDiagnosticReport(diagnosticInfo.Severity, True, diagnosticInfo.MessageIdentifier,
                                                               Location.None, diagnosticInfo.Category, options.GeneralDiagnosticOption,
                                                               options.SpecificDiagnosticOptions, hasSourceSuppression)
    End Function

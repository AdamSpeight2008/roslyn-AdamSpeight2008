...
Namespace Microsoft.CodeAnalysis.VisualBasic
  ...
  Public Structure LocalizableErrorArgument
    ...
    ''' <summary> Creates a string representing the unformatted LocalizableErrorArgument instance. </summary>
    Public Overrides Function ToString() As String
      Return ToString_IFormattable(Nothing, Nothing)
    End Function

    ''' <summary> Creates a string representing the formatted LocalizableErrorArgument instance. </summary>
    ...
    Public Function ToString_IFormattable(
                                           format           As String,

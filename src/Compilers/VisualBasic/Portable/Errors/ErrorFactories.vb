...
Namespace Microsoft.CodeAnalysis.VisualBasic
  ...
  Friend Class ErrorFactory
    ...
    Friend Shared ReadOnly Property ResourceManager As Resources.ResourceManager
      Get
        s_resourceManager = If(s_resourceManager, New Resources.ResourceManager("VBResources", GetType(ERRID).GetTypeInfo().Assembly))
    ...
    Public Shared Function GetHelpLink(id As ERRID) As String
      ...
      If s_helpLinksMap.Value.TryGetValue(id, helpLink) Then Return helpLink
      Return String.Empty
    End Function

    Public Shared Function GetCategory(id As ERRID) As String
      Dim category As String = Nothing
      If s_categoriesMap.Value.TryGetValue(id, category) Then Return category
      Return Diagnostic.CompilerDiagnosticCategory
    End Function
  End Class


  ''' <summary> Concatenates messages for a set of DiagnosticInfo. </summary>

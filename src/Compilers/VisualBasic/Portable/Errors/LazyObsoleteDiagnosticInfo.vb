...
Namespace Microsoft.CodeAnalysis.VisualBasic
  ...
  Friend NotInheritable Class LazyObsoleteDiagnosticInfo
    ...
    Friend Overrides Function GetResolvedInfo() As DiagnosticInfo
      If _lazyActualObsoleteDiagnostic IsNot Nothing Then Return _lazyActualObsoleteDiagnostic
      ...
      Dim info = If(kind = ObsoleteDiagnosticKind.Diagnostic, ObsoleteAttributeHelpers.CreateObsoleteDiagnostic(_symbol), Nothing)

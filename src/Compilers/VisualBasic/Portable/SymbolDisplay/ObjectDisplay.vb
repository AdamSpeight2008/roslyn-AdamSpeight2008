...
#Disable Warning CA1200 ' Avoid using cref tags with a prefix
  ''' <summary> Displays a value in the VisualBasic style. </summary>
...
#Enable Warning CA1200 ' Avoid using cref tags with a prefix
  Friend Module ObjectDisplay
    ...
    ''' <summary> Returns a string representation of an object of primitive type. </summary>
    ...
    Public Function FormatPrimitive(
                                     obj     As Object,
                                     options As ObjectDisplayOptions
                                   ) As String
    ...
    Friend Function FormatLiteral(
      ...
      If IsPrintable(c) OrElse Not options.IncludesOption(ObjectDisplayOptions.EscapeNonPrintableCharacters) Then
         Return If(options.IncludesOption(ObjectDisplayOptions.UseQuotes), """" & EscapeQuote(c) & """c", c.ToString())
      End If
      Dim wellKnown = GetWellKnownCharacterName(c)
      If wellKnown IsNot Nothing Then Return wellKnown
    ...
    Friend Function FormatLiteral(
      ...
      ValidateOptions(options)
      If options.IncludesOption(ObjectDisplayOptions.UseHexadecimalNumbers) Then Return "&H" & If(value >= 0, value.ToString("X2"), CInt(value).ToString("X8"))
    ...
    Friend Function FormatLiteral(
      ...
      ValidateOptions(options)
      If options.IncludesOption(ObjectDisplayOptions.UseHexadecimalNumbers) Then Return "&H" & value.ToString("X2")
      Return value.ToString(GetFormatCulture(cultureInfo))
    End Function
    ...
    Friend Function FormatLiteral(
      ...
      End If
      If options.IncludesOption(ObjectDisplayOptions.IncludeTypeSuffix) Then sb.Append("S"c)
      Return pooledBuilder.ToStringAndFree()
    End Function
    ...
    Friend Function FormatLiteral(
      ...
      Else
        sb.Append(value.ToString(GetFormatCulture(cultureInfo)))
      End If
      If options.IncludesOption(ObjectDisplayOptions.IncludeTypeSuffix) Then sb.Append("US")
      Return pooledBuilder.ToStringAndFree()
    End Function
    ...
    Friend Function FormatLiteral(
      ...
      Else
        sb.Append(value.ToString(GetFormatCulture(cultureInfo)))
      End If
      If options.IncludesOption(ObjectDisplayOptions.IncludeTypeSuffix) Then sb.Append("I"c)
      Return pooledBuilder.ToStringAndFree()
    End Function
    ...
    Friend Function FormatLiteral(
      ...
      Else
        sb.Append(value.ToString(GetFormatCulture(cultureInfo)))
      End If
      If options.IncludesOption(ObjectDisplayOptions.IncludeTypeSuffix) Then sb.Append("UI")
      Return pooledBuilder.ToStringAndFree()
    End Function
    ...
    Friend Function FormatLiteral(
      ...
      Else
        sb.Append(value.ToString(GetFormatCulture(cultureInfo)))
      End If
      If options.IncludesOption(ObjectDisplayOptions.IncludeTypeSuffix) Then sb.Append("L"c)
      Return pooledBuilder.ToStringAndFree()
    End Function
    ...
    Friend Function FormatLiteral(
      ...
      If options.IncludesOption(ObjectDisplayOptions.IncludeTypeSuffix) Then sb.Append("UL")
      Return pooledBuilder.ToStringAndFree()
    End Function
    ...
    Friend Iterator Function TokenizeString(
                                             str     As String,
                                             options As ObjectDisplayOptions
      ...
      While i < str.Length
        ...
        If shouldEscape Then
          ...
          End If
        Else
          If isFirst AndAlso useQuotes Then Yield Quotes()
        ...
        End If
      End While
      If useQuotes AndAlso lastConcatenandWasQuoted Then Yield Quotes()
    End Function
    ...
    Friend Function GetWellKnownCharacterName(c As Char) As String
      Select Case c
             Case s_nullChar    : Return "vbNullChar"
             Case s_back        : Return "vbBack"
             Case s_Cr          : Return "vbCr"
             Case s_formFeed    : Return "vbFormFeed"
             Case s_Lf          : Return "vbLf"
             Case s_tab         : Return "vbTab"
             Case s_verticalTab : Return "vbVerticalTab"
      End Select
      Return Nothing
    End Function

...
Namespace Microsoft.CodeAnalysis.VisualBasic
  ...
  ''' <summary> Supported Visual Basic language versions. </summary>
  ...
  Public Module LanguageVersionFacts
    ...
    ''' <summary> Map a language version (such as Default, Latest, Or VisualBasicN) to a specific version (VisualBasicN). </summary>
    <Extension>
    ...
    ''' <summary> Parse a LanguageVersion from a string input, as the command-line compiler does. </summary>
    Public Function TryParse(version As String, ByRef result As LanguageVersion) As Boolean
      ...
      Else
        Select Case version.ToLowerInvariant()
          Case "9", "9.0"     : result = LanguageVersion.VisualBasic9
          Case "10", "10.0"   : result = LanguageVersion.VisualBasic10
          Case "11", "11.0"   : result = LanguageVersion.VisualBasic11
          Case "12", "12.0"   : result = LanguageVersion.VisualBasic12
          Case "14", "14.0"   : result = LanguageVersion.VisualBasic14
          ...
          Case Else           : result = LanguageVersion.Default : valid = False
        End Select
      End If
      Return valid
    End Function

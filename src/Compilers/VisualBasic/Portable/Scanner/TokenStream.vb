...
Namespace Microsoft.CodeAnalysis.VisualBasic.Syntax.InternalSyntax
  ...
  Friend Enum ScannerState
    ''' <summary> Scan VB tokens</summary>
    VB
    ''' <summary> Scan VB tokens but consume multiline trivia before token. Done at the start of a new statement except after line if. </summary>
    VBAllowLeadingMultilineTrivia
    ''' <summary> Scan tokens in Xml misc state, these are tokens between document declaration and the root element </summary>
    Misc
    ''' <summary> Scan tokens inside of &lt;!DOCTYPE ... &gt; </summary>
    DocType
    ''' <summary> Scan tokens inside of &lt; ... &gt; </summary>
    Element
    ''' <summary> Scan tokens inside of &lt;/ ...&gt; </summary>
    EndElement
    ''' <summary> Scan a single quoted string </summary>
    SingleQuotedString
    ''' <summary> Scan a single quoted string RIGHT_SINGLE_QUOTATION_MARK </summary>
    SmartSingleQuotedString
    ''' <summary> Scan a quoted string </summary>
    QuotedString
    ''' <summary> Scan a quoted string RIGHT_DOUBLE_QUOTATION_MARK </summary>
    SmartQuotedString
    ''' <summary> Scan a string that is missing quotes (error recovery) </summary>
    UnQuotedString
    ''' <summary> Scan text between markup </summary>
    Content
    ''' <summary> Scan text inside of &lt;![CDATA[ ... ]]&gt; </summary>
    CData
    ''' <summary> Scan first text inside f &lt;? ... ?&gt;, the first text can have leading trivia </summary>
    StartProcessingInstruction
    ''' <summary> Scan remaining text inside of &lt;? ... ?&gt; </summary>
    ProcessingInstruction
    ''' <summary> Scan text inside of &lt;!-- ... --&gt; </summary>
    Comment
    ''' <summary> Scan punctuation in an interpolated string. </summary>
    InterpolatedStringPunctuation
    ''' <summary> Scan interpolated string text content. </summary>
    InterpolatedStringContent
    ''' <summary> Scan interpolated string format string text content (no newlines). </summary>
...
#End If
    ...
    Private Function GetScannerToken(state As ScannerState) As SyntaxToken
      Select Case state
        ...
        Case ScannerState.VBAllowLeadingMultilineTrivia     : Return Me.GetNextToken(allowLeadingMultilineTrivia:=Not _isScanningDirective)

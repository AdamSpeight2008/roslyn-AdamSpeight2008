...
Namespace Microsoft.CodeAnalysis.VisualBasic.Syntax
  ...
  Friend Class KeywordTable
    ...
    Friend Shared Function CanFollowExpression(kind As SyntaxKind) As Boolean
        ...
        If (s_keywordProperties.TryGetValue(kind, description)) Then Return description.kdCanFollowExpr
        Return False
    End Function

    Friend Shared Function IsQueryClause(kind As SyntaxKind) As Boolean
        Dim description As KeywordDescription = Nothing
        If (s_keywordProperties.TryGetValue(kind, description)) Then Return description.kdIsQueryClause
        Return False
    End Function

    Friend Shared Function TokenOpPrec(kind As SyntaxKind) As OperatorPrecedence
        Dim description As KeywordDescription = Nothing
        If (s_keywordProperties.TryGetValue(kind, description)) Then Return description.kdOperPrec

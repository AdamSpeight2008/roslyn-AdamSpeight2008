...
Namespace Microsoft.CodeAnalysis.VisualBasic.Syntax.InternalSyntax
  ...
  Friend Class Scanner
    ...
    Private Shared ReadOnly s_keywordKindFactory As Func(Of String, SyntaxKind) = Function(spelling) KeywordTable.TokenOfString(spelling)
...
#Region "New line and explicit line continuation."
    ...
    Private Function ScanNewlineAsTrivia(StartCharacter As Char) As SyntaxTrivia
      Return If( LengthOfLineBreak(StartCharacter) = 2, MakeEndOfLineTriviaCRLF(), MakeEndOfLineTrivia(GetNextChar))
    End Function

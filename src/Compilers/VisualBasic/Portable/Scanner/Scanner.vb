...
FullWidthRepeat:
        ...
        'Function MakeGuid_Hex(here As Integer, precedingTrivia As CoreInternalSyntax.SyntaxList(Of VisualBasicSyntaxNode)) As CodeAnalysis.SyntaxToken
        'End Function
        'Function MakeGuid_HexPrefix(here As Integer, precedingTrivia As CoreInternalSyntax.SyntaxList(Of VisualBasicSyntaxNode)) As CodeAnalysis.SyntaxToken
        'End Function
        'Function MakeGuid_Bo(here As Integer, precedingTrivia As CoreInternalSyntax.SyntaxList(Of VisualBasicSyntaxNode)) As CodeAnalysis.SyntaxToken
        'End Function
        'Function MakeGuid_Bc(here As Integer, precedingTrivia As CoreInternalSyntax.SyntaxList(Of VisualBasicSyntaxNode)) As CodeAnalysis.SyntaxToken
        'End Function
        'Function MakeGuid_Po(here As Integer, precedingTrivia As CoreInternalSyntax.SyntaxList(Of VisualBasicSyntaxNode)) As CodeAnalysis.SyntaxToken
        'End Function
        'Function MakeGuid_Pc(here As Integer, precedingTrivia As CoreInternalSyntax.SyntaxList(Of VisualBasicSyntaxNode)) As CodeAnalysis.SyntaxToken
        'End Function
        'Function MakeGuid_Comma(here As Integer, precedingTrivia As CoreInternalSyntax.SyntaxList(Of VisualBasicSyntaxNode)) As CodeAnalysis.SyntaxToken
        'End Function
        'Function MakeGuid_Hypen(here As Integer, precedingTrivia As CoreInternalSyntax.SyntaxList(Of VisualBasicSyntaxNode)) As CodeAnalysis.SyntaxToken
        'End Function
        'Function MakeGuid_Literal(prefix As SyntaxToken, body As SyntaxToken, precedingTrivia As CoreInternalSyntax.SyntaxList(Of VisualBasicSyntaxNode)) As CodeAnalysis.SyntaxToken
        'End Function

        'Private Function Scan_Guid_Core(here As Integer, precedingTrivia As CoreInternalSyntax.SyntaxList(Of VisualBasicSyntaxNode), ByRef output As CodeAnalysis.SyntaxToken) As Boolean
        '    Dim ch As Char
        '    If TryGet(here, ch) Then
        '        Select Case ch
        '            Case "0"c
        '                Dim nc As Char
        '                If TryGet(here + 1, nc) AndAlso (nc = "x"c OrElse nc = "X"c) Then
        '                    ' Marks the start of a prefixed hex
        '                    output = MakeGuid_HexPrefix(here, precedingTrivia)
        '                    Return True
        '                Else
        '                    ' He
        '                    output = MakeGuid_Hex(here, precedingTrivia)
        '                    Return True
        '                End If
        '            Case "1"c To "9"c, "a"c To "f"c, "A"c To "F"c
        '                output = MakeGuid_Hex(here, precedingTrivia)
        '                Return True
        '            Case "("c
        '                output = MakeGuid_Po(here, precedingTrivia)
        '                Return True
        '            Case ")"c
        '                output = MakeGuid_Pc(here, precedingTrivia)
        '                Return True
        '            Case "{"c
        '                output = MakeGuid_Bo(here, precedingTrivia)
        '                Return True
        '            Case "}"c
        '                output = MakeGuid_Bc(here, precedingTrivia)
        '                Return True
        '            Case "-"c
        '                output = MakeGuid_Hypen(here, precedingTrivia)
        '                Return True
        '            Case ","c
        '                output = MakeGuid_Comma(here, precedingTrivia)
        '                Return True
        '            Case Else
        '                output = MakeBadToken(precedingTrivia, 1, ERRID.ERR_None)
        '                Return False
        '        End Select
        '    Else
        '        output = MakeBadToken(precedingTrivia, 1, ERRID.ERR_None)
        ...
        'Private Function Scan_Guid_Body(here As Integer, precedingTrivia As CoreInternalSyntax.SyntaxList(Of VisualBasicSyntaxNode)) As SyntaxToken
        '    Dim st As SyntaxTokenList = Nothing
        '    Dim token As CodeAnalysis.SyntaxToken = Nothing
        '    If Scan_Guid_Core(here, precedingTrivia, token) Then
        '        st = SyntaxTokenList.Create(token)
        '    Else
        '    End If

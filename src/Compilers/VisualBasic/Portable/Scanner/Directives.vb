...
Namespace Microsoft.CodeAnalysis.VisualBasic.Syntax.InternalSyntax
    ...
    Partial Friend Class Scanner
      ...
      Private Shared Function ApplyDirectivesRecursive(preprocessorState As PreprocessorState, node As GreenNode) As PreprocessorState
       ...
       If sCount > 0 Then
         For i As Integer = 0 To sCount - 1
           ...
           If child IsNot Nothing AndAlso child.ContainsDirectives Then preprocessorState = ApplyDirectivesRecursive(preprocessorState, child)
         Next
         Return preprocessorState
        End If
      ...
      Private Sub New(
        ...
        Me.SymbolsMap               = symbols
        Me.ConditionalStack         = conditionals
        Me.RegionDirectiveStack     = regionDirectives
      ...
      Private Function SetSymbol(name As String, value As CConst) As PreprocessorState
        Dim symbols = Me.SymbolsMap
        symbols = symbols.SetItem(name, value)
        Return New PreprocessorState(symbols, Me.ConditionalStack, Me.RegionDirectiveStack, Me.HaveSeenRegionDirectives, Me.ExternalSourceDirective)
      End Function
      ...
      Private Function WithConditionals(conditionals As ImmutableStack(Of ConditionalState)) As PreprocessorState
        Return New PreprocessorState(Me.SymbolsMap, conditionals, Me.RegionDirectiveStack, Me.HaveSeenRegionDirectives, Me.ExternalSourceDirective)
      End Function
      ...
      Private Function WithRegions(regions As ImmutableStack(Of RegionDirectiveTriviaSyntax)) As PreprocessorState
        Return New PreprocessorState(Me.SymbolsMap, Me.ConditionalStack, regions, Me.HaveSeenRegionDirectives OrElse regions.Count > 0, Me.ExternalSourceDirective)
      End Function
      ...
      Private Function WithExternalSource(externalSource As ExternalSourceDirectiveTriviaSyntax) As PreprocessorState
        Return New PreprocessorState(Me.SymbolsMap, Me.ConditionalStack, Me.RegionDirectiveStack, Me.HaveSeenRegionDirectives, externalSource)
      End Function
      ...
      Friend Function IsEquivalentTo(other As PreprocessorState) As Boolean
        ...
        If Me.ConditionalStack.Count > 0 OrElse
           Me.SymbolsMap.Count > 0 OrElse
           Me.ExternalSourceDirective IsNot Nothing OrElse
           other.ConditionalStack.Count > 0 OrElse
           other.SymbolsMap.Count > 0 OrElse
           other.ExternalSourceDirective IsNot Nothing Then
           Return False
        End If
        If Me.RegionDirectiveStack.Count <> other.RegionDirectiveStack.Count Then Return False
        If Me.HaveSeenRegionDirectives <> other.HaveSeenRegionDirectives Then Return False
        Return True
      End Function

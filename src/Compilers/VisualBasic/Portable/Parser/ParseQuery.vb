...
Namespace Microsoft.CodeAnalysis.VisualBasic.Syntax.InternalSyntax
    ...
    Partial Friend Class Parser
        ...
        Private Function ParseSelectList() As CodeAnalysis.Syntax.InternalSyntax.SeparatedSyntaxList(Of ExpressionRangeVariableSyntax)
            ...
            Loop while TryParse_Comma(RangeVariables)
        ...
        Private Function ParseLetList() As CodeAnalysis.Syntax.InternalSyntax.SeparatedSyntaxList(Of ExpressionRangeVariableSyntax)
            ...
            Do
                ...
                If varName.ContainsDiagnostics Then
                    ...
                    Select Case (peek)
                        Case SyntaxKind.AsKeyword, SyntaxKind.InKeyword, SyntaxKind.CommaToken
        ...
        Private Function ParseFromControlVars() As CodeAnalysis.Syntax.InternalSyntax.SeparatedSyntaxList(Of CollectionRangeVariableSyntax)
            ...
            Do
                ...
                If CurrentToken.Kind = SyntaxKind.QuestionToken AndAlso
                    (IsToken(PeekToken(1), SyntaxKind.InKeyword, SyntaxKind.EqualsToken)) Then
        ...
        Private Function ParseInnerJoinOrGroupJoinExpression(groupKw As KeywordSyntax, joinKw As KeywordSyntax) As JoinClauseSyntax
        ...
        Private Function ParseJoinControlVar() As CollectionRangeVariableSyntax
            ...
            If varName.ContainsDiagnostics Then
                ...
                Select Case (peek)
                    Case SyntaxKind.AsKeyword, SyntaxKind.InKeyword, SyntaxKind.GroupKeyword,
                         SyntaxKind.JoinKeyword, SyntaxKind.OnKeyword
            ...
            If CurrentToken.Kind = SyntaxKind.AsKeyword Then
                ...
                If Type.ContainsDiagnostics Then
                    ...
                    Select Case (peek)
                        Case SyntaxKind.EqualsToken, SyntaxKind.InKeyword, SyntaxKind.GroupKeyword,
                             SyntaxKind.JoinKeyword, SyntaxKind.OnKeyword
        ...
        Private Function ParseJoinPredicateExpression() As CodeAnalysis.Syntax.InternalSyntax.SeparatedSyntaxList(Of JoinConditionSyntax)
            ...
            Do
                ...
                ElseIf CurrentToken.Kind.IsIn(SyntaxKind.AndAlsoKeyword, SyntaxKind.OrKeyword, SyntaxKind.OrElseKeyword) Then
        ...
        Private Function ParseOrderByList() As CodeAnalysis.Syntax.InternalSyntax.SeparatedSyntaxList(Of OrderingSyntax)
            ...
            Do
                ...
                If OrderExpression.ContainsDiagnostics Then
                    OrderExpression = ResyncAt(OrderExpression,
                                               SyntaxKind.CommaToken,      SyntaxKind.AscendingKeyword, SyntaxKind.DescendingKeyword,
                                               SyntaxKind.WhereKeyword,    SyntaxKind.GroupKeyword,     SyntaxKind.SelectKeyword,
                                               SyntaxKind.OrderKeyword,    SyntaxKind.JoinKeyword,      SyntaxKind.FromKeyword,
                                               SyntaxKind.DistinctKeyword, SyntaxKind.AggregateKeyword, SyntaxKind.IntoKeyword,
                                               SyntaxKind.SkipKeyword,     SyntaxKind.TakeKeyword,      SyntaxKind.LetKeyword)
                End If
            ...
            Loop While TryParse_Comma(exprs)

            Return exprs.ToListAndFree(_pool)
        End Function

        Private Function TryParse_Comma(Of T As GreenNode)(
                                         ByRef separatedList As SeparatedSyntaxListBuilder(Of T),
                                      Optional createIfMissing As Boolean = False) As Boolean

            Dim comma As PunctuationSyntax = Nothing
            Dim valid As Boolean = TryEatNewLineAndGetToken(SyntaxKind.CommaToken, comma, createIfMissing)
            If valid Then
                TryEatNewLine()
                separatedList.AddSeparator(comma)
            End If
            Return valid
        End Function
        ...
        Private Sub ParseMoreQueryOperators(ByRef operators As SyntaxListBuilder(Of QueryClauseSyntax))
            Do
                ...
                If operators.Count > 0 AndAlso operators(operators.Count - 1).ContainsDiagnostics Then
                    ...
                    operators(last) = ResyncAt(operators(last), SyntaxKind.FromKeyword,     SyntaxKind.WhereKeyword,     SyntaxKind.GroupKeyword,
                                                                SyntaxKind.SelectKeyword,   SyntaxKind.OrderKeyword,     SyntaxKind.JoinKeyword,
                                                                SyntaxKind.DistinctKeyword, SyntaxKind.AggregateKeyword, SyntaxKind.IntoKeyword,
                                                                SyntaxKind.SkipKeyword,     SyntaxKind.TakeKeyword,      SyntaxKind.LetKeyword)
                End If
        ...
        Private Function ParseFromQueryExpression(fromKw As KeywordSyntax) As QueryExpressionSyntax
            ...
            Dim result = operators.ToListAndFree(_pool)

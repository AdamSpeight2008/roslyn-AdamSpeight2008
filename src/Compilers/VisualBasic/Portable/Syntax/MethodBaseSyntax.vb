...
Namespace Microsoft.CodeAnalysis.VisualBasic
  ...
  Partial Public Class SyntaxFacts
    ...
    <EditorBrowsable(EditorBrowsableState.Never), Obsolete("This member is obsolete. Use IsAccessorStatementAccessorKeyword instead.", True)>
    ...
    <EditorBrowsable(EditorBrowsableState.Never), Obsolete("This member is obsolete. Use IsDeclareStatementSubOrFunctionKeyword instead.", True)>
    ...
    <EditorBrowsable(EditorBrowsableState.Never), Obsolete("This member is obsolete. Use IsDelegateStatementSubOrFunctionKeyword instead.", True)>
    ...
    <EditorBrowsable(EditorBrowsableState.Never), Obsolete("This member is obsolete. Use IsLambdaHeaderSubOrFunctionKeyword instead.", True)>
    Public Shared Function IsLambdaHeaderKeyword(kind As SyntaxKind) As Boolean
      Return IsLambdaHeaderSubOrFunctionKeyword(kind)
    End Function

    <EditorBrowsable(EditorBrowsableState.Never), Obsolete("This member is obsolete. Use IsMethodStatementSubOrFunctionKeyword instead.", True)>

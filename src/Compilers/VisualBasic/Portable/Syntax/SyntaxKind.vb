...
Namespace Microsoft.CodeAnalysis.VisualBasic
    ...
    Public Enum SyntaxKind As UShort
        ...
        ''' <summary> A class to represent an empty statement. This can occur when a colon is on a line without anything else. </summary>
        ...
        ''' <summary> Represents the clause of an Imports statement that imports all members of a type or namespace or aliases a type or namespace. </summary>
        ...
        ''' <summary> Represents the beginning statement of a namespace declaration. This node always appears as the Begin of a BlockStatement with Kind=NamespaceBlock. </summary>
        NamespaceStatement                      = 49    ' NamespaceStatementSyntax : DeclarationStatementSyntax : StatementSyntax

        ''' <summary> Represents a declaration of Module, its contents and the End statement that ends it. </summary>
        ModuleBlock                             = 50    ' ModuleBlockSyntax : TypeBlockSyntax : DeclarationStatementSyntax : StatementSyntax
        ''' <summary> Represents a declaration of a Structure, its contents and the End statement that ends it. </summary>
        StructureBlock                          = 51    ' StructureBlockSyntax : TypeBlockSyntax : DeclarationStatementSyntax : StatementSyntax
        ''' <summary> Represents a declaration of a Interface, its contents and the End statement that ends it. </summary>
        InterfaceBlock                          = 52    ' InterfaceBlockSyntax : TypeBlockSyntax : DeclarationStatementSyntax : StatementSyntax
        ''' <summary> Represents a declaration of a Class its contents and the End statement that ends it. </summary>
        ClassBlock                              = 53    ' ClassBlockSyntax : TypeBlockSyntax : DeclarationStatementSyntax : StatementSyntax
        ''' <summary> Represents a declaration of an Enum, its contents and the End Enum statement that ends it. </summary>
        ...
        ''' <summary> Represents the beginning statement of a Module declaration. This node always appears as the Begin of a TypeBlock with Kind=ModuleDeclarationBlock. </summary>
        ...
        ''' <summary> Represents the beginning statement of a Interface declaration. This node always appears as the Begin of a TypeBlock with Kind=InterfaceDeclarationBlock. </summary>
        InterfaceStatement                      = 61    ' InterfaceStatementSyntax : TypeStatementSyntax : DeclarationStatementSyntax : StatementSyntax
        ''' <summary> Represents the beginning statement of a Class declaration. This node always appears as the Begin of a TypeBlock with Kind=ClassDeclarationBlock. </summary>
        ClassStatement                          = 62    ' ClassStatementSyntax : TypeStatementSyntax : DeclarationStatementSyntax : StatementSyntax
        ''' <summary> Represents the beginning statement of an Enum declaration. This node always appears as the Begin of an EnumBlock with Kind=EnumDeclarationBlock. </summary>
        ...
        ''' <summary> Represents the "Handles ..." clause on a method declaration that describes which events this method handles. </summary>
        HandlesClause                           = 113   ' HandlesClauseSyntax
        ''' <summary> Represents event container specified through special keywords "Me", "MyBase" or "MyClass". </summary>
        ...
        ''' <summary> Represents a "From {...} clause used to initialize a new collection object's elements. </summary>
        ObjectCollectionInitializer             = 126   ' ObjectCollectionInitializerSyntax : ObjectCreationInitializerSyntax
        ''' <summary> Represent a field initializer in a With {...} initializer where the field name is inferred from the initializer expression. </summary>
        InferredFieldInitializer                = 127   ' InferredFieldInitializerSyntax : FieldInitializerSyntax
        ''' <summary> Represent a named field initializer in a With {...} initializer, such as ".x = expr". </summary>
        NamedFieldInitializer                   = 128   ' NamedFieldInitializerSyntax : FieldInitializerSyntax
        ''' <summary> Represents an "= initializer" clause in a declaration for a variable, parameter or automatic property. </summary>
        ...
        ''' <summary> Represents an identifier with optional "?" or "()" or "(,,,)" modifiers, as used in parameter declarations and variable declarations. </summary>
        ModifiedIdentifier                      = 133   ' ModifiedIdentifierSyntax
        ''' <summary> Represents a modifier that describes an array type, without bounds, such as "()" or "(,)". </summary>
        ...
        ''' <summary> Represents a file-level attribute, in which the attributes have no other syntactic element they are attached to. </summary>
        AttributesStatement                     = 138   ' AttributesStatementSyntax : DeclarationStatementSyntax : StatementSyntax
        ''' <summary> Represent an expression in a statement context. This may only be a invocation or await expression in standard code but may be any expression in VB Interactive code. </summary>
        ...
        ''' <summary> Represents a While...End While statement, including the While, body and End While. </summary>
        ...
        ''' <summary> A label for a GoTo, Resume, or On Error statement. An identifier, line number, or next keyword. </summary>
        ...
        ''' <summary> Represents a "Stop" or "End" statement. The Kind can be used to determine which kind of statement this is. </summary>
        ...
        ''' <summary> An exit statement. The kind of block being exited can be found by examining the Kind. </summary>
        ...
        ''' <summary> Represents a "Continue (block)" statement. THe kind of block referenced can be determined by examining the Kind. </summary>
        ...
        ''' <summary> Represents a block If...Then...Else...EndIf Statement. The Kind property can be used to determine if it is a block or line If. </summary>
        ...
        ''' <summary> Represents the Catch part of a Try...Catch...Finally...End Try. This statement is always the Begin of a CatchPart. </summary>
        CatchStatement                          = 190   ' CatchStatementSyntax : StatementSyntax
        ''' <summary> Represents the When/Filter clause of a Catch statement. </summary>
        CatchFilterClause                       = 191   ' CatchFilterClauseSyntax
        ''' <summary> Represents the Finally part of a Try...Catch...Finally...End Try. This statement is always the Begin of a FinallyPart. </summary>
        ...
        ''' <summary> Represents the "SyncLock" statement. This statement always occurs as the Begin of a SyncLockBlock. </summary>
        ...
        ''' <summary> Represents a simple, compound, or Mid assignment statement. Which one can be' determined by checking the Kind. </summary>
        ...
        ''' <summary> Represent an call statement (also known as a invocation statement). </summary>
        CallStatement                           = 261  ' CallStatementSyntax : ExecutableStatementSyntax : StatementSyntax
        ''' <summary> Represents an AddHandler or RemoveHandler statement. The Kind property determines which one. </summary>
        ...
        ''' <summary> Represents an expression that creates a new array without naming the element type. </summary>
        ...
        ''' <summary> Represents a conditional expression, If(condition, true-expr, false-expr) or If(expr, nothing-expr). </summary>
        ...
        ''' <summary> Represents a "Skip While" or "Take While" query operator. The Kind property tells which. </summary>
        ...
        ''' <summary>' Represents a string of XML characters embedded as the content of an XML element. </summary>
        ...
        ''' <summary> Represents an XML comment of the form &lt;!-- Comment --&gt; appearing in an XML literal expression. </summary>
        XmlComment                              = 392   ' XmlCommentSyntax : XmlNodeSyntax : ExpressionSyntax
        ''' <summary> Represents an XML processing instruction of the form '&lt;? XMLProcessingTarget XMLProcessingValue ?&gt;'. </summary>
        ...
        ''' <summary> Represents an embedded expression in an XML literal e.g. '&lt;name&gt;&lt;%= obj.Name =%&gt;&lt;/name&gt;'. </summary>
        XmlEmbeddedExpression                   = 395   ' XmlEmbeddedExpressionSyntax : XmlNodeSyntax : ExpressionSyntax
        ''' <summary> Represents an array type, such as "A() or "A(,)", without bounds specified for the array. </summary>
        ...
        ''' <summary> Represents an occurrence of a Visual Basic built-in type such as Integer or String in source code. </summary>
        PredefinedType                          = 398   ' PredefinedTypeSyntax : TypeSyntax : ExpressionSyntax
        ''' <summary> Represents a type name consisting of a single identifier (which might include brackets or a type character). </summary>
        IdentifierName                          = 399   ' IdentifierNameSyntax : SimpleNameSyntax : NameSyntax : TypeSyntax : ExpressionSyntax
        
        ''' <summary> Represents a simple type name with one or more generic arguments, such as "X(Of Y, Z)." </summary>
        ...
        ''' <summary> Syntax node class that represents a value of 'cref' attribute inside documentation comment trivia. </summary>
        CrefReference                           = 404   ' CrefReferenceSyntax
        ''' <summary> Represents a parenthesized list of argument types for a signature inside CrefReferenceSyntax syntax. </summary>
        ...
        ''' <summary> Represent a Await expression. </summary>
        AwaitExpression                         = 412   ' AwaitExpressionSyntax : ExpressionSyntax

        #Region "Keywords"
        ''' <summary> Represents a single keyword in a VB program. Which keyword can be determined from the Kind property. </summary>
        ...
        ''' <summary> Represents a single punctuation mark or operator in a VB program. Which one can be determined from the Kind property. </summary>
        ...
        ''' <summary> Represents an Date literal token. </summary>
        ...
        ''' <summary> Represents true whitespace: spaces, tabs, newlines and the like. </summary>
        WhitespaceTrivia                        = 729   ' SyntaxTrivia
        ''' <summary> Represents line breaks that are syntactically insignificant. </summary>
        EndOfLineTrivia                         = 730   ' SyntaxTrivia
        ''' <summary> Represents colons that are syntactically insignificant. </summary>
        ColonTrivia                             = 731   ' SyntaxTrivia
        ''' <summary> Represents a comment. </summary>
        CommentTrivia                           = 732   ' SyntaxTrivia
        ''' <summary> Represents an explicit line continuation character at the end of a line, i.e. "_"c </summary>
        LineContinuationTrivia                  = 733   ' SyntaxTrivia
        ''' <summary> Represents a ''' prefix for an XML Documentation Comment. </summary>
        DocumentationCommentExteriorTrivia      = 734   ' SyntaxTrivia
        ''' <summary> Represents text in a false preprocessor block. </summary>
        DisabledTextTrivia                      = 735   ' SyntaxTrivia

        #Region "# Directives"
        ' DirectiveTriviaSyntax : StructuredTriviaSyntax
        ''' <summary> Represents a #Const pre-processing constant declaration appearing in source. </summary>
        ConstDirectiveTrivia                    = 736   ' ConstDirectiveTriviaSyntax : DirectiveTriviaSyntax
        ''' <summary> Represents the beginning of an #If pre-processing directive appearing in source. </summary>
        IfDirectiveTrivia                       = 737   ' IfDirectiveTriviaSyntax : DirectiveTriviaSyntax
        ''' <summary> Represents the beginning of an #If pre-processing directive appearing in source. </summary>
        ElseIfDirectiveTrivia                   = 738   ' IfDirectiveTriviaSyntax : DirectiveTriviaSyntax
        ''' <summary> Represents an #Else pre-processing directive appearing in source. </summary>
        ElseDirectiveTrivia                     = 739   ' ElseDirectiveTriviaSyntax : DirectiveTriviaSyntax
        ''' <summary>' Represents an #End If pre-processing directive appearing in source. </summary>
        EndIfDirectiveTrivia                    = 740   ' EndIfDirectiveTriviaSyntax : DirectiveTriviaSyntax
        ''' <summary> Represents the beginning of a #Region directive appearing in source. </summary>
        RegionDirectiveTrivia                   = 741   ' RegionDirectiveTriviaSyntax : DirectiveTriviaSyntax
        ''' <summary> Represents an #End Region directive appearing in source. </summary>
        EndRegionDirectiveTrivia                = 744   ' EndRegionDirectiveTriviaSyntax : DirectiveTriviaSyntax
        ''' <summary> Represents the beginning of a #ExternalSource pre-processing directive appearing in source. </summary>
        ExternalSourceDirectiveTrivia           = 745   ' ExternalSourceDirectiveTriviaSyntax : DirectiveTriviaSyntax
        ''' <summary> Represents an #End ExternalSource pre-processing directive appearing in source. </summary>
        EndExternalSourceDirectiveTrivia        = 746   ' EndExternalSourceDirectiveTriviaSyntax : DirectiveTriviaSyntax
        ''' <summary> Represents an #ExternalChecksum pre-processing directive appearing in source. </summary>
        ExternalChecksumDirectiveTrivia         = 747   ' ExternalChecksumDirectiveTriviaSyntax : DirectiveTriviaSyntax
        ''' <summary> Represents #Enable Warning pre-processing directive appearing in source. </summary>
        EnableWarningDirectiveTrivia            = 748   ' EnableWarningDirectiveTriviaSyntax : DirectiveTriviaSyntax
        ''' <summary> Represents #Disable Warning pre-processing directive appearing in source. </summary>
        DisableWarningDirectiveTrivia           = 749   ' DisableWarningDirectiveTriviaSyntax : DirectiveTriviaSyntax
        ''' <summary> Represents an #r directive appearing in scripts. </summary>
        ReferenceDirectiveTrivia                = 750   ' ReferenceDirectiveTriviaSyntax : DirectiveTriviaSyntax
        ''' <summary>
        ...
        ''' directive.
        ''' </summary>
        BadDirectiveTrivia                      = 753   ' BadDirectiveTriviaSyntax : DirectiveTriviaSyntax
        #End Region
        ...
        #Region "Do ... Loop"
        ''' <summary> Represents a "Do ... Loop" block. </summary>
        ...
        ''' <summary> Represents a simple "Do" statement that begins a "Do ... Loop" block. </summary>
        SimpleDoStatement                       = 770   ' DoStatement : StatementSyntax : VisualBasicSyntaxNode
        ''' <summary> Represents a "Do While" statement that begins a "Do ... Loop" block. </summary>
        DoWhileStatement                        = 771   ' DoStatement : StatementSyntax : VisualBasicSyntaxNode
        ''' <summary> Represents a "Do Until" statement that begins a "Do ... Loop" block. </summary>
        DoUntilStatement                        = 772   ' DoStatement : StatementSyntax : VisualBasicSyntaxNode
        ''' <summary> Represents a simple "Loop" statement that end a "Do ... Loop" block. </summary>
        SimpleLoopStatement                     = 773   ' LoopStatement : StatementSyntax : VisualBasicSyntaxNode
        ''' <summary> Represents a "Loop While" statement that end a "Do ... Loop" block. </summary>
        LoopWhileStatement                      = 774   ' LoopStatement : StatementSyntax : VisualBasicSyntaxNode
        ''' <summary> Represents a "Loop Until" statement that end a "Do ... Loop" block. </summary>
        LoopUntilStatement                      = 775   ' LoopStatement : StatementSyntax : VisualBasicSyntaxNode
        ''' <summary> Represents a "While ..." clause of a "Do" or "Loop" statement. </summary>
        WhileClause                             = 776   ' WhileOrUntilClause : VisualBasicSyntaxNode
        ''' <summary> Represents an "Until ..." clause of a "Do" or "Loop" statement. </summary>
        ...
        ''' <summary> Represents an embedded expression in an interpolated string expression e.g. '{expression[,alignment][:formatString]}'. </summary>
        Interpolation                           = 782   ' InterpolationSyntax : InterpolatedStringContentSyntax
        ''' <summary> Represents an alignment clause ', alignment' of an interpolated string embedded expression. </summary>
        InterpolationAlignmentClause            = 783   ' InterpolationAlignmentClauseSyntax : VisualBasicSyntaxNode
        ''' <summary> Represents a format string clause ':formatString' of an interpolated string embedded expression. </summary>
        InterpolationFormatClause               = 784   ' InterpolationFormatClauseSyntax : VisualBasicSyntaxNode
        ''' <summary> Represents a '$"' token in an interpolated string expression. </summary>
        ...
        ''' <summary> Represents the end of interpolated string when parsing. </summary>
        EndOfInterpolatedStringToken            = 787   ' PunctuationSyntax : SyntaxToken
        #End Region
        #Region "Tuple"
        ''' <summary> Represents tuple literal expression. </summary>
        TupleExpression                         = 788
        ''' <summary> Represents tuple type. </summary>
        TupleType                               = 789
        ''' <summary> Represents an element of a tuple type supplying only the type. </summary>
        TypedTupleElement                       = 790
        ''' <summary> Represents an element of a tuple type supplying element name and optionally a type. </summary>
        NamedTupleElement                       = 791
        #End Region
        ''' <summary> Trivia created when merge conflict markers (like "&lt;&lt;&lt;&lt;&lt;&lt;&lt;") are detected in source code. </summary>

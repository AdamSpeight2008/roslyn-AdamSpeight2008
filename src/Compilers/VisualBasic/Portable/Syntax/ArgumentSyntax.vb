...
Namespace Microsoft.CodeAnalysis.VisualBasic.Syntax
    ...
    ''' <summary> Gets a value indicating whether this argument is a named argument. </summary>
    ...
    ''' <summary> Gets a value indicating whether this argument is an omitted argument. </summary>
    ...
    ''' <summary> Gets the expression of this argument, if any. </summary>

...
Namespace Microsoft.CodeAnalysis.VisualBasic.Syntax
  ...
  Partial Public Class TypeBlockSyntax
    ...
    <EditorBrowsable(EditorBrowsableState.Never), Obsolete("This member is obsolete. Use BlockStatement or a more specific property (e.g. ClassStatement) instead.", True)>
    ...
    <EditorBrowsable(EditorBrowsableState.Never), Obsolete("This member is obsolete. Use WithBlockStatement or a more specific property (e.g. WithClassStatement) instead.", True)>
    Public Function WithBegin(begin As TypeStatementSyntax) As TypeBlockSyntax
      Return WithBlockStatement(begin)
    End Function
    
    <EditorBrowsable(EditorBrowsableState.Never),Obsolete("This member is obsolete. Use EndBlockStatement or a more specific property (e.g. EndClassStatement) instead.", True)>
    ...
    <EditorBrowsable(EditorBrowsableState.Never), Obsolete("This member is obsolete. Use WithEndBlockStatement or a more specific property (e.g. WithEndClassStatement) instead.", True)>

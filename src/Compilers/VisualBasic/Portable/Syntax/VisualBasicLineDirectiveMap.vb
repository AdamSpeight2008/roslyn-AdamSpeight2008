...
Namespace Microsoft.CodeAnalysis.VisualBasic.Syntax
  ...
  ''' <summary> Adds VB specific parts to the line directive map </summary>
  Friend Class VisualBasicLineDirectiveMap
    ...
    Friend Overrides Function TranslateSpanAndVisibility(
                                                          sourceText As SourceText,
                                                          treeFilePath As String,
                                                          span As TextSpan,
                                                    ByRef isHiddenPosition As Boolean
                                                        ) As FileLinePositionSpan

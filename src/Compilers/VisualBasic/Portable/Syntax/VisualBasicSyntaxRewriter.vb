  ...
  Partial Public Class VisualBasicSyntaxRewriter
    ...
    Public Overridable Function VisitToken(token As SyntaxToken) As SyntaxToken
      ...
      If leading <> token.LeadingTrivia OrElse trailing <> token.TrailingTrivia Then
        If leading <> token.LeadingTrivia Then token = token.WithLeadingTrivia(leading)
        If trailing <> token.TrailingTrivia Then token = token.WithTrailingTrivia(trailing)
      End If
      Return token
    End Function
    ...
    Public Overridable Function VisitList(Of TNode As SyntaxNode)(list As SyntaxList(Of TNode)) As SyntaxList(Of TNode)
      ...
      While i < n
        ...
        If alternate IsNot Nothing AndAlso visited IsNot Nothing AndAlso visited.Kind <> SyntaxKind.None Then alternate.Add(visited)
        i = i + 1
      End While

      If alternate IsNot Nothing Then Return alternate.ToList(Of TNode)()
      Return list
    End Function
    ...
    Public Overridable Function VisitList(list As SyntaxTokenList) As SyntaxTokenList
      ...
      For Each item In list
        ...
        End If
      Next
      If alternate IsNot Nothing Then Return alternate.ToList()
      Return list
    End Function
    ...
    Public Overridable Function VisitList(Of TNode As SyntaxNode)(list As SeparatedSyntaxList(Of TNode)) As SeparatedSyntaxList(Of TNode)
      ...
      While i < sepCount
        ...
        If Not alternate.IsNull Then
          If visitedNode IsNot Nothing Then
            ...
            If visitedSeparator.RawKind = 0 Then Throw New InvalidOperationException("separator is expected")
      ...
      If i < count Then
        ...
        If alternate.IsNull Then
          ...
          End If
        End If
        If Not alternate.IsNull AndAlso visitedNode IsNot Nothing Then alternate.Add(visitedNode)
      End If
      If Not alternate.IsNull Then Return alternate.ToList()
      Return list
    End Function
    ...
    Public Overridable Function VisitList(list As SyntaxTriviaList) As SyntaxTriviaList
      ...
      For Each item In list
        ...
        End If
        If alternate IsNot Nothing AndAlso visited.Kind() <> SyntaxKind.None Then alternate.Add(visited)
      Next
      If alternate IsNot Nothing Then Return alternate.ToList()
      Return list
    End Function

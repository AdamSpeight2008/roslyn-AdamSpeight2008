...
Namespace Microsoft.CodeAnalysis.VisualBasic.Syntax
  ...
  Partial Public Class MethodBlockBaseSyntax
    ...
    ''' <summary> The statement that begins the block declaration. </summary>
    Public MustOverride ReadOnly Property BlockStatement As MethodBaseSyntax

    ''' <summary> The statement that ends the block declaration. </summary>
    ...
    <EditorBrowsable(EditorBrowsableState.Never), Obsolete("This member is obsolete. Use BlockStatement or a more specific property (e.g. SubOrFunctionStatement) instead.", True)>
    ...
    <EditorBrowsable(EditorBrowsableState.Never), Obsolete("This member is obsolete. Use WithBlockStatement or a more specific property (e.g. WithSubOrFunctionStatement) instead.", True)>
    Public Function WithBegin(begin As MethodBaseSyntax) As MethodBlockBaseSyntax
      Return WithBlockStatement(begin)
    End Function

    <EditorBrowsable(EditorBrowsableState.Never), Obsolete("This member is obsolete. Use EndBlockStatement or a more specific property (e.g. EndSubOrFunctionStatement) instead.", True)>
    ...
    <EditorBrowsable(EditorBrowsableState.Never), Obsolete("This member is obsolete. Use WithEndBlockStatement or a more specific property (e.g. WithEndSubOrFunctionStatement) instead.", True)>
  ...
  Partial Public Class AccessorBlockSyntax
    ...
    <EditorBrowsable(EditorBrowsableState.Never), Obsolete("This member is obsolete. Use AccessorStatement instead.", True)>
    ...
    <EditorBrowsable(EditorBrowsableState.Never), Obsolete("This member is obsolete. Use EndAccessorStatement instead.", True)>
    ...
    <EditorBrowsable(EditorBrowsableState.Never), Obsolete("This member is obsolete. Use WithAccessorStatement instead.", True)>
    ...
    <EditorBrowsable(EditorBrowsableState.Never), Obsolete("This member is obsolete. Use WithEndAccessorStatement instead.", True)>

...
Namespace Microsoft.CodeAnalysis.VisualBasic.Syntax
  ...
  Friend Module SyntaxEquivalence
    ...
    Private Function AreEquivalentRecursive(
      ...
      If before Is after Then Return True
      If before Is Nothing OrElse after Is Nothing Then Return False
      If before.RawKind <> after.RawKind Then Return False
      ...
      If Not AreModifiersEquivalent(before, after, kind) Then Return False
      ...
      If topLevel Then
        Select Case kind
          ...
          Case SyntaxKind.EqualsValue
            ...
            If parentKind = SyntaxKind.PropertyStatement Then Return True
        End Select
      End If
      ...
      If ignoreChildNode IsNot Nothing Then
        ...
        While True
          ...
          If Not AreEquivalentRecursive(child1, child2, kind, ignoreChildNode, topLevel) Then Return False
        End While
      ...
      Else
        ...
        If slotCount1 <> after.SlotCount Then Return False
    ...
    Private Function AreModifiersEquivalent(
      ...
      Select Case kind
        Case SyntaxKind.SubBlock,
          ...
          If beforeModifiers.Count <> afterModifiers.Count Then  Return False
          For i = 0 To beforeModifiers.Count - 1
            If Not beforeModifiers.Any(afterModifiers(i).Kind) Then Return False
          Next
        End Select
        Return True
     End Function

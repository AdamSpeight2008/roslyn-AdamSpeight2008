...
Namespace Microsoft.CodeAnalysis.VisualBasic.Syntax.InternalSyntax
  Friend Partial Class ArgumentSyntax
    ...
    Public Function GetExpression() As ExpressionSyntax
      Select Case Kind
        Case SyntaxKind.OmittedArgument : Return SyntaxFactory.MissingExpression
        Case SyntaxKind.RangeArgument   : Return DirectCast(Me, RangeArgumentSyntax).UpperBound
      End Select

...
Namespace Microsoft.CodeAnalysis.VisualBasic.Syntax.InternalSyntax
  ...
  Partial Friend MustInherit Class VisualBasicSyntaxVisitor
    ...
    Public Overridable Function VisitSyntaxToken(
    ...
    Public Overridable Function VisitSyntaxTrivia(
  ...
  Partial Friend Class VisualBasicSyntaxRewriter
    ...
    Public Function VisitList(Of TNode As VisualBasicSyntaxNode)(
                                                                  list As CodeAnalysis.Syntax.InternalSyntax.SyntaxList(Of TNode)
                                                                ) As CodeAnalysis.Syntax.InternalSyntax.SyntaxList(Of TNode)
      ...
      Do While (i < n)
        ...
        If Not alternate.IsNull Then
           If visited IsNot Nothing AndAlso visited.Kind <> SyntaxKind.None Then alternate.Add(visited)
         End If
        i += 1
      Loop
    ...
    Public Function VisitList(Of TNode As VisualBasicSyntaxNode)(
                                                                  list As CodeAnalysis.Syntax.InternalSyntax.SeparatedSyntaxList(Of TNode)
                                                                ) As CodeAnalysis.Syntax.InternalSyntax.SeparatedSyntaxList(Of TNode)
      ...
      While i < itemCount
        ...
        If Not alternate.IsNull Then
          If visitedItem IsNot Nothing AndAlso visitedItem.Kind <> SyntaxKind.None Then
            ...
            If visitedSeparator IsNot Nothing Then alternate.AddSeparator(visitedSeparator)

...
Namespace Microsoft.CodeAnalysis.VisualBasic.Syntax.InternalSyntax
  ...
  Friend NotInheritable Class ComplexIdentifierSyntax
    ...
    ''' <summary> Contextual Nodekind </summary>
    ...
    ''' <summary> If true, the identifier was enclosed in brackets, such as "[End]". </summary>
    ...
    ''' <summary> The text of the identifier, not including the brackets or type character. </summary>

...
Namespace Microsoft.CodeAnalysis.VisualBasic
  ...
  Public Partial Class VisualBasicSyntaxTree
    ...
    Partial Private Class ParsedSyntaxTree
      ...
      ''' <summary> Used to create new tree incrementally. </summary>
      ...
      ''' <summary> Get a reference to the given node. </summary>
      ...
      Public Overrides Function WithRootAndOptions(root As SyntaxNode, options As ParseOptions) As SyntaxTree
        If _root Is root AndAlso _options Is options Then Return Me
        Return New ParsedSyntaxTree( Nothing,
                                     _encodingOpt,
                                     _checksumAlgorithm,
                                     _path,
      ...
      Public Overrides Function WithFilePath(path As String) As SyntaxTree
        If String.Equals(_path, path) Then Return Me

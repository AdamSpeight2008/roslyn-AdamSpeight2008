  ...
  Partial Public Class DirectiveTriviaSyntax
    ...
    Private Function GetNextRelatedDirective() As DirectiveTriviaSyntax
      ...
      Select Case d.Kind
             ...
             Case SyntaxKind.ElseDirectiveTrivia
                  While d IsNot Nothing
                    If d.Kind = SyntaxKind.EndIfDirectiveTrivia Then Return d
                    d = d.GetNextPossiblyRelatedDirective()
                  End While
             Case SyntaxKind.RegionDirectiveTrivia
                  While d IsNot Nothing
                    If d.Kind = SyntaxKind.EndRegionDirectiveTrivia Then Return d
                    d = d.GetNextPossiblyRelatedDirective()
                  End While
      End Select
      Return Nothing
    ...
    Private Function GetPreviousRelatedDirective() As DirectiveTriviaSyntax
      ...
      Select Case d.Kind
             ...
             Case SyntaxKind.ElseIfDirectiveTrivia
                  While d IsNot Nothing
                    If d.Kind = SyntaxKind.IfDirectiveTrivia Then Return d
                    d = d.GetPreviousPossiblyRelatedDirective()
                  End While
             Case SyntaxKind.ElseDirectiveTrivia
                  While d IsNot Nothing
             ...
             Case SyntaxKind.EndRegionDirectiveTrivia
                  While d IsNot Nothing
                    If d.Kind = SyntaxKind.RegionDirectiveTrivia Then Return d
                    d = d.GetPreviousPossiblyRelatedDirective()
                  End While
      End Select
      Return Nothing

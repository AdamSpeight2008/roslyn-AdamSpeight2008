...
Namespace Microsoft.CodeAnalysis.VisualBasic
  ...
  Public Module SyntaxExtensions
    ...
    <Extension>
    Public Function NormalizeWhitespace(Of TNode As SyntaxNode)(
                                                                 node               As TNode,
                                                                 useDefaultCasing   As Boolean,
                                                                 indentation        As String,
                                                                 elasticTrivia      As Boolean
                                                               ) As TNode
      Return CType(SyntaxNormalizer.Normalize(node, indentation, CodeAnalysis.SyntaxNodeExtensions.DefaultEOL, elasticTrivia, useDefaultCasing), TNode)
    End Function
    ...
    Public Function NormalizeWhitespace(Of TNode As SyntaxNode)(
                                                        ...
                                                        Optional elasticTrivia      As Boolean  = False
                                                               ) As TNode
    ...
    Public Function NormalizeWhitespace(
      ...
      Return SyntaxNormalizer.Normalize(token, indentation, CodeAnalysis.SyntaxNodeExtensions.DefaultEOL, elasticTrivia, False)
    End Function
    ...
    Public Function NormalizeWhitespace(
                                ...
                                Optional eol                As String   = CodeAnalysis.SyntaxNodeExtensions.DefaultEOL,
                                Optional elasticTrivia      As Boolean  = False,
                                Optional useDefaultCasing   As Boolean  = False
                                       ) As SyntaxToken
    ...
    ''' <summary> Returns the TypeSyntax of the given NewExpressionSyntax if specified. </summary>
    <Extension>
    Public Function Type(
                          newExpressionSyntax As NewExpressionSyntax
                        ) As TypeSyntax
      Select Case newExpressionSyntax.Kind
        Case SyntaxKind.ObjectCreationExpression            : Return DirectCast(newExpressionSyntax, ObjectCreationExpressionSyntax).Type
        Case SyntaxKind.AnonymousObjectCreationExpression   : Return Nothing
       Case SyntaxKind.ArrayCreationExpression              : Return DirectCast(newExpressionSyntax, ArrayCreationExpressionSyntax).Type
      End Select
      Throw ExceptionUtilities.UnexpectedValue(newExpressionSyntax.Kind)
    End Function

    ''' <summary> Returns the TypeSyntax of the given AsClauseSyntax if specified. </summary>
    <Extension> 
    Public Function Type(
                          asClauseSyntax As AsClauseSyntax
                        ) As TypeSyntax
      Select Case asClauseSyntax.Kind
        Case SyntaxKind.SimpleAsClause  : Return DirectCast(asClauseSyntax, SimpleAsClauseSyntax).Type
        Case SyntaxKind.AsNewClause     : Return DirectCast(asClauseSyntax, AsNewClauseSyntax).NewExpression.Type
      End Select
      Throw ExceptionUtilities.UnexpectedValue(asClauseSyntax.Kind)
    End Function

      ''' <summary> Returns the AttributeBlockSyntax of the given AsClauseSyntax if specified. </summary>
      <Extension> 
      Public Function Attributes(
                                  asClauseSyntax As AsClauseSyntax
                                ) As SyntaxList(Of AttributeListSyntax)
        Select Case asClauseSyntax.Kind
          Case SyntaxKind.SimpleAsClause    : Return DirectCast(asClauseSyntax, SimpleAsClauseSyntax).AttributeLists
          Case SyntaxKind.AsNewClause       : Return DirectCast(asClauseSyntax, AsNewClauseSyntax).NewExpression.AttributeLists
      End Select
      Throw ExceptionUtilities.UnexpectedValue(asClauseSyntax.Kind)
    End Function
    ...
    ''' </summary>
    <Extension>
    Public Function TryGetInferredMemberName(

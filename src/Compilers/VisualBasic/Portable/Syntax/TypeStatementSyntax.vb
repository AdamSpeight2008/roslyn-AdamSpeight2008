...
Namespace Microsoft.CodeAnalysis.VisualBasic.Syntax
  ...
  Partial Public Class TypeStatementSyntax
    ...
    Public MustOverride Function WithDeclarationKeyword(keyword As SyntaxToken) As TypeStatementSyntax
        ...
        <EditorBrowsable(EditorBrowsableState.Never), Obsolete("This member is obsolete. Use DeclarationKeyword or a more specific property (e.g. ClassKeyword) instead.", True)>
    ...
    <EditorBrowsable(EditorBrowsableState.Never), Obsolete("This member is obsolete. Use DeclarationKeyword or a more specific property (e.g. WithClassKeyword) instead.", True)>

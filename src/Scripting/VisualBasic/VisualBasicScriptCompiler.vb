...
Namespace Microsoft.CodeAnalysis.VisualBasic.Scripting
    ...
    Friend NotInheritable Class VisualBasicScriptCompiler
        ...
        Private Shared ReadOnly s_defaultOptions As VisualBasicParseOptions = New VisualBasicParseOptions(kind:=SourceCodeKind.Script, languageVersion:=Version.LanguageVersionService.Latest)

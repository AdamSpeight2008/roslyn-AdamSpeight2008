...
Namespace Microsoft.CodeAnalysis.Editor.VisualBasic.Formatting.Indentation
  ...
  <Export(GetType(VSCommanding.ICommandHandler)), ContentType(ContentTypeNames.VisualBasicContentType), Name(PredefinedCommandHandlerNames.Indent), Order(After:=PredefinedCommandHandlerNames.Rename)>
  Friend Class SmartTokenFormatterCommandHandler
    ...
    Protected Overrides Function GetFormattingRules _ 
            (
    ...
    Protected Overrides Function IsInvalidToken(token As SyntaxToken) As Boolean
      ...
      Return token.IsKind(SyntaxKind.None, SyntaxKind.EndOfFileToken)
    End Function

...
End Module
            ...
            Await TestAsync(code, expected, parseOptions:=New VisualBasicParseOptions(languageVersion:=Language.Version.LanguageVersionService.LanguageVersion.VisualBasic16))
        End Function
